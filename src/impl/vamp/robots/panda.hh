...
namespace vamp::robots
{
    struct Panda
    {
        ...
        inline static auto tsr_function(const std::array<float, 33> &x, std::array<float, 48> &y) noexcept
        {
            ...
            v[40] = -0.316 * v[7] + 0.0825 * v[13] + -0.0825 * v[21] + 0.384 * v[24] +
                    0.088 * (v[30] * v[31] + v[34] * v[36] + v[37] * v[35]) +
                    0.212 * (-1. * (v[30] * v[38] + v[34] * v[39] + v[37] * v[31]) +
                             4.89663865010925e-12 * (-1. * v[34] + 4.89663865010925e-12 * v[37]));
            ...
            v[52] = cos(x[0]);
            y[0] =
                0. - (v[40] * v[2] + v[50] * v[5]) * v[51] +
                (v[48] * 4.89663865010925e-12 + v[46] * v[10] + v[49] * v[11] + v[40] * v[6] + v[50] * v[8]) *
                    -1. * v[52];
            v[48] = sin(x[1]);
            v[53] = cos(x[1]);
            y[1] = 0. - (v[50] * v[0] + v[40] * v[4] * 4.89663865010925e-12) * v[48] +
                   (v[50] * v[4] * 4.89663865010925e-12 + v[40] * v[0] * -1.) * v[53];
            v[50] = sin(x[2]);
            v[40] = cos(x[2]);
            y[2] = 0. - (v[46] * v[4] + v[49] * v[9] + v[46] * v[7] * 4.89663865010925e-12) * v[50] +
                   (v[49] * v[4] + v[49] * v[7] * 4.89663865010925e-12 + v[46] * v[9] * -1.) * v[40];
            v[49] = sin(x[3]);
            v[46] = cos(x[3]);
            y[3] = 0. - (v[44] * v[20] + v[47] * v[13] + v[44] * v[17] * 4.89663865010925e-12) * v[49] +
                   (v[47] * v[20] + v[47] * v[17] * 4.89663865010925e-12 + v[44] * v[13] * -1.) * v[46];
            v[47] = sin(x[4]);
            v[44] = cos(x[4]);
            y[4] = 0. - (v[45] * v[21] + v[42] * v[28] * -1. + v[42] * v[24] * 4.89663865010925e-12) * v[47] +
                   (v[45] * v[28] * -1. + v[45] * v[24] * 4.89663865010925e-12 + v[42] * v[21] * -1.) * v[44];
            v[45] = sin(x[5]);
            v[42] = cos(x[5]);
            y[5] = 0. - (v[41] * v[37] + v[43] * v[30] + v[41] * v[34] * 4.89663865010925e-12) * v[45] +
                   (v[43] * v[37] + v[43] * v[34] * 4.89663865010925e-12 + v[41] * v[30] * -1.) * v[42];
            ...
            v[9] = -0.316 * v[43] + 0.0825 * v[37] + -0.0825 * v[28] + 0.384 * v[24] +
                   0.088 * (v[20] * v[31] + v[17] * v[36] + v[13] * v[35]) +
                   0.212 * (-1. * (v[20] * v[38] + v[17] * v[39] + v[13] * v[31]) +
                            4.89663865010925e-12 * (-1. * v[17] + 4.89663865010925e-12 * v[13]));
            v[7] = blend(1., 0., 0. - v[9]);
            v[9] = blend(1., 0., v[9] - 0.);
            v[9] = v[7] + v[9];
            v[7] = v[9] * 0.212;
            ...
            y[7] =
                0. -
                (v[59] * 4.89663865010925e-12 + v[57] * v[10] + v[60] * v[11] + v[9] * v[6] + v[61] * v[8]) *
                    v[51] +
                (v[9] * v[2] + v[61] * v[5]) * v[52];
            y[8] = 0. - (v[61] * v[3] + v[9] * v[0] * 4.89663865010925e-12) * v[48] +
                   (v[61] * v[0] * 4.89663865010925e-12 + v[9] * v[3] * -1.) * v[53];
            y[9] = 0. - (v[57] * v[0] + v[60] * v[41] + v[57] * v[43] * 4.89663865010925e-12) * v[50] +
                   (v[60] * v[0] + v[60] * v[43] * 4.89663865010925e-12 + v[57] * v[41] * -1.) * v[40];
            y[10] = 0. - (v[55] * v[30] + v[58] * v[37] + v[55] * v[34] * 4.89663865010925e-12) * v[49] +
                    (v[58] * v[30] + v[58] * v[34] * 4.89663865010925e-12 + v[55] * v[37] * -1.) * v[46];
            y[11] = 0. - (v[56] * v[28] + v[4] * v[21] * -1. + v[4] * v[24] * 4.89663865010925e-12) * v[47] +
                    (v[56] * v[21] * -1. + v[56] * v[24] * 4.89663865010925e-12 + v[4] * v[28] * -1.) * v[44];
            y[12] = 0. - (v[7] * v[13] + v[54] * v[20] + v[7] * v[17] * 4.89663865010925e-12) * v[45] +
                    (v[54] * v[13] + v[54] * v[17] * 4.89663865010925e-12 + v[7] * v[20] * -1.) * v[42];
            v[5] = -1. * v[5];
            v[1] = -1. * v[1];
            ...
            v[24] = 0.333 + -0.316 * v[5] + 0.0825 * v[11] + -0.0825 * v[13] + 0.384 * v[17] +
                    0.088 * (v[56] * v[31] + v[4] * v[36] + v[21] * v[35]) +
                    0.212 * (-1. * (v[56] * v[38] + v[4] * v[39] + v[21] * v[31]) +
                             4.89663865010925e-12 * (-1. * v[4] + 4.89663865010925e-12 * v[21]));
            ...
            y[15] = 0. -
                    (v[24] * -0.316 + (v[33] * 4.89663865010925e-12 + v[35] * v[14] + v[26] * v[18]) * -1. +
                     v[23] * v[16] + v[22] * v[12]) *
                        -1. * v[48] +
                    (v[23] * v[15] + v[22] * v[10]) * -1. * v[53];
            y[16] =
                0. -
                (v[23] * 4.89663865010925e-12 + v[22] * v[1] + v[23] * v[5] * 4.89663865010925e-12) * v[50] +
                (v[22] * 4.89663865010925e-12 + v[22] * v[5] * 4.89663865010925e-12 + v[23] * v[1] * -1.) *
                    v[40];
            y[17] = 0. - (v[35] * v[7] + v[26] * v[11] + v[35] * v[54] * 4.89663865010925e-12) * v[49] +
                    (v[26] * v[7] + v[26] * v[54] * 4.89663865010925e-12 + v[35] * v[11] * -1.) * v[46];
            y[18] =
                0. - (v[38] * v[13] + v[58] * v[20] * -1. + v[58] * v[17] * 4.89663865010925e-12) * v[47] +
                (v[38] * v[20] * -1. + v[38] * v[17] * 4.89663865010925e-12 + v[58] * v[13] * -1.) * v[44];
            y[19] = 0. - (v[28] * v[21] + v[55] * v[56] + v[28] * v[4] * 4.89663865010925e-12) * v[45] +
                    (v[55] * v[21] + v[55] * v[4] * 4.89663865010925e-12 + v[28] * v[56] * -1.) * v[42];
            v[55] = 2. * x[16];
            v[28] = v[55] * x[16];
            v[21] = 2. * x[17];
            v[4] = v[21] * x[17];
            ...
            v[26] = -0.316 * v[54] + 0.0825 * v[1] + -0.0825 * v[53] + 0.384 * v[16] + 0.088 * v[39] +
                    0.212 * v[27] + (0.707106781186865 * v[57] + -0.70710678118623 * v[26]) * v[51] +
                    (0.70710678118623 * v[57] + 0.707106781186865 * v[26]) * v[59] + v[27] * v[8];
            ...
            v[17] = -0.316 * v[7] + 0.0825 * v[47] + -0.0825 * v[44] + 0.384 * v[57] + 0.088 * v[39] +
                    0.212 * v[27] + (0.707106781186865 * v[16] + -0.70710678118623 * v[17]) * v[51] +
                    (0.70710678118623 * v[16] + 0.707106781186865 * v[17]) * v[59] + v[27] * v[8];
            v[35] = -1. * v[35];
            v[13] = -1. * v[13];
            ...
            v[50] = 0.333 + -0.316 * v[35] + 0.0825 * v[23] + -0.0825 * v[24] + 0.384 * v[18] +
                    0.088 * v[31] + 0.212 * v[32] +
                    (0.707106781186865 * v[60] + -0.70710678118623 * v[50]) * v[51] +
                    (0.70710678118623 * v[60] + 0.707106781186865 * v[50]) * v[59] + v[32] * v[8];
            v[20] = (-v[56]) * x[18] + (-v[38]) * x[19] + (-v[20]) * x[20] + v[56] * v[26] + v[38] * v[17] +
                    v[20] * v[50];
            v[38] = v[20] - x[21];
            ...
            v[42] = v[42] * x[14];
            v[38] = v[21] + v[42];
            v[38] = (-v[45]) * x[18] + (-v[4]) * x[19] + (-v[38]) * x[20] + v[45] * v[26] + v[4] * v[17] +
                    v[38] * v[50];
            v[4] = v[38] - x[22];
            ...
            v[42] = v[21] - v[42];
            v[20] = 1. - (v[20] + v[28]);
            v[20] = (-v[55]) * x[18] + (-v[42]) * x[19] + (-v[20]) * x[20] + v[55] * v[26] + v[42] * v[17] +
                    v[20] * v[50];
            v[42] = v[20] - x[23];
        ...
        inline static auto tsr_function_ori_blend_simd(const InputVector &x, OutputVector &out) noexcept
        {
            FloatVector<8, 100> v;
            FloatVector<8, 48> y;
            v[0] = cos(x[0]);
            ...
            v[39] = -v[35];
            v[40] = 4.89663865010925e-12 * v[31];
            v[41] = v[30] * v[39] + v[34] * v[40] + v[37] * v[31];
            v[42] = -1. * v[34] + 4.89663865010925e-12 * v[37];
            v[43] = -0.316 * v[7] + 0.0825 * v[13] + -0.0825 * v[21] + 0.384 * v[24] + 0.088 * v[38] +
                    0.212 * (-1. * v[41] + 4.89663865010925e-12 * v[42]);
            v[44] = blend(0., 1., 0. - v[43]);
            v[43] = blend(0., 1., v[43] - 0.);
            v[43] = v[44] + v[43];
            v[44] = v[43] * 0.212;
            v[45] = v[44] * 4.89663865010925e-12;
            v[44] = v[44] * -1.;
            v[46] = v[43] * 0.088;
            v[47] = v[45] * 4.89663865010925e-12 + v[44] * v[31] + v[46] * v[35];
            v[45] = v[45] * -1. + v[44] * v[40] + v[46] * v[36];
            v[48] = v[44] * v[39] + v[46] * v[31];
            v[49] = v[47] * 4.89663865010925e-12 + v[45] * v[33] + v[48] * v[29];
            v[47] = v[43] * 0.384 + v[47] + v[45] * v[32] + v[48] * v[27];
            v[50] = v[43] * -0.0825 + v[45] * v[26] + v[48] * v[25];
            v[51] = v[49] * 4.89663865010925e-12 + v[47] * v[14] + v[50] * v[18];
            v[49] = v[49] * -1. + v[47] * v[23] + v[50] * v[19];
            v[52] = v[43] * 0.0825 + v[47] * v[22] + v[50] * v[14];
            v[43] = v[43] * -0.316 + v[51] * -1. + v[49] * v[16] + v[52] * v[12];
            v[53] = v[49] * v[15] + v[52] * v[10];
            v[54] = sin(x[0]);
            v[55] = cos(x[0]);
            y[0] =
                0. - (v[43] * v[2] + v[53] * v[5]) * v[54] +
                (v[51] * 4.89663865010925e-12 + v[49] * v[10] + v[52] * v[11] + v[43] * v[6] + v[53] * v[8]) *
                    -1. * v[55];
            v[51] = sin(x[1]);
            v[56] = cos(x[1]);
            y[1] = 0. - (v[53] * v[0] + v[43] * v[4] * 4.89663865010925e-12) * v[51] +
                   (v[53] * v[4] * 4.89663865010925e-12 + v[43] * v[0] * -1.) * v[56];
            v[53] = sin(x[2]);
            v[43] = cos(x[2]);
            y[2] = 0. - (v[49] * v[4] + v[52] * v[9] + v[49] * v[7] * 4.89663865010925e-12) * v[53] +
                   (v[52] * v[4] + v[52] * v[7] * 4.89663865010925e-12 + v[49] * v[9] * -1.) * v[43];
            v[52] = sin(x[3]);
            v[49] = cos(x[3]);
            y[3] = 0. - (v[47] * v[20] + v[50] * v[13] + v[47] * v[17] * 4.89663865010925e-12) * v[52] +
                   (v[50] * v[20] + v[50] * v[17] * 4.89663865010925e-12 + v[47] * v[13] * -1.) * v[49];
            v[50] = sin(x[4]);
            v[47] = cos(x[4]);
            y[4] = 0. - (v[48] * v[21] + v[45] * v[28] * -1. + v[45] * v[24] * 4.89663865010925e-12) * v[50] +
                   (v[48] * v[28] * -1. + v[48] * v[24] * 4.89663865010925e-12 + v[45] * v[21] * -1.) * v[47];
            v[48] = sin(x[5]);
            v[45] = cos(x[5]);
            y[5] = 0. - (v[44] * v[37] + v[46] * v[30] + v[44] * v[34] * 4.89663865010925e-12) * v[48] +
                   (v[46] * v[37] + v[46] * v[34] * 4.89663865010925e-12 + v[44] * v[30] * -1.) * v[45];
            v[46] = v[3] * v[2] + v[0] * v[6];
            v[44] = v[3] * v[5] + v[0] * v[8];
            v[57] = v[44] * v[10] + v[46] * v[12] + v[0] * v[11];
            v[58] = v[44] * v[15] + v[46] * v[16] + v[0] * v[10];
            v[59] = -1. * v[46] + 4.89663865010925e-12 * v[0];
            v[60] = v[57] * v[14] + v[58] * v[19] + v[59] * v[18];
            v[61] = v[57] * v[22] + v[58] * v[23] + v[59] * v[14];
            v[62] = -1. * v[58] + 4.89663865010925e-12 * v[59];
            v[63] = v[60] * v[25] + v[61] * v[27] + v[62] * v[29];
            v[64] = v[60] * v[26] + v[61] * v[32] + v[62] * v[33];
            v[65] = v[61] + 4.89663865010925e-12 * v[62];
            v[66] = v[63] * v[31] + v[64] * v[36] + v[65] * v[35];
            v[67] = v[63] * v[39] + v[64] * v[40] + v[65] * v[31];
            v[68] = -1. * v[64] + 4.89663865010925e-12 * v[65];
            v[69] = -0.316 * v[46] + 0.0825 * v[57] + -0.0825 * v[60] + 0.384 * v[61] + 0.088 * v[66] +
                    0.212 * (-1. * v[67] + 4.89663865010925e-12 * v[68]);
            v[70] = blend(0., 1., 0. - v[69]);
            v[69] = blend(0., 1., v[69] - 0.);
            v[69] = v[70] + v[69];
            v[70] = v[69] * 0.212;
            v[71] = v[70] * 4.89663865010925e-12;
            v[70] = v[70] * -1.;
            v[72] = v[69] * 0.088;
            v[73] = v[71] * 4.89663865010925e-12 + v[70] * v[31] + v[72] * v[35];
            v[71] = v[71] * -1. + v[70] * v[40] + v[72] * v[36];
            v[74] = v[70] * v[39] + v[72] * v[31];
            v[75] = v[73] * 4.89663865010925e-12 + v[71] * v[33] + v[74] * v[29];
            v[73] = v[69] * 0.384 + v[73] + v[71] * v[32] + v[74] * v[27];
            v[76] = v[69] * -0.0825 + v[71] * v[26] + v[74] * v[25];
            v[77] = v[75] * 4.89663865010925e-12 + v[73] * v[14] + v[76] * v[18];
            v[75] = v[75] * -1. + v[73] * v[23] + v[76] * v[19];
            v[78] = v[69] * 0.0825 + v[73] * v[22] + v[76] * v[14];
            v[69] = v[69] * -0.316 + v[77] * -1. + v[75] * v[16] + v[78] * v[12];
            v[79] = v[75] * v[15] + v[78] * v[10];
            y[7] =
                0. -
                (v[77] * 4.89663865010925e-12 + v[75] * v[10] + v[78] * v[11] + v[69] * v[6] + v[79] * v[8]) *
                    v[54] +
                (v[69] * v[2] + v[79] * v[5]) * v[55];
            y[8] = 0. - (v[79] * v[3] + v[69] * v[0] * 4.89663865010925e-12) * v[51] +
                   (v[79] * v[0] * 4.89663865010925e-12 + v[69] * v[3] * -1.) * v[56];
            y[9] = 0. - (v[75] * v[0] + v[78] * v[44] + v[75] * v[46] * 4.89663865010925e-12) * v[53] +
                   (v[78] * v[0] + v[78] * v[46] * 4.89663865010925e-12 + v[75] * v[44] * -1.) * v[43];
            y[10] = 0. - (v[73] * v[59] + v[76] * v[57] + v[73] * v[58] * 4.89663865010925e-12) * v[52] +
                    (v[76] * v[59] + v[76] * v[58] * 4.89663865010925e-12 + v[73] * v[57] * -1.) * v[49];
            y[11] =
                0. - (v[74] * v[60] + v[71] * v[62] * -1. + v[71] * v[61] * 4.89663865010925e-12) * v[50] +
                (v[74] * v[62] * -1. + v[74] * v[61] * 4.89663865010925e-12 + v[71] * v[60] * -1.) * v[47];
            y[12] = 0. - (v[70] * v[65] + v[72] * v[63] + v[70] * v[64] * 4.89663865010925e-12) * v[48] +
                    (v[72] * v[65] + v[72] * v[64] * 4.89663865010925e-12 + v[70] * v[63] * -1.) * v[45];
            v[72] = -1. * v[5];
            v[1] = -1. * v[1];
            v[70] = v[1] * v[10] + v[72] * v[12] + 4.89663865010925e-12 * v[11];
            v[74] = v[1] * v[15] + v[72] * v[16] + 4.89663865010925e-12 * v[10];
            v[71] = 2.39770700697438e-23 + -1. * v[72];
            v[76] = v[70] * v[14] + v[74] * v[19] + v[71] * v[18];
            v[73] = v[70] * v[22] + v[74] * v[23] + v[71] * v[14];
            v[78] = -1. * v[74] + 4.89663865010925e-12 * v[71];
            v[75] = v[76] * v[25] + v[73] * v[27] + v[78] * v[29];
            v[79] = v[76] * v[26] + v[73] * v[32] + v[78] * v[33];
            v[69] = v[73] + 4.89663865010925e-12 * v[78];
            v[77] = v[75] * v[31] + v[79] * v[36] + v[69] * v[35];
            v[80] = v[75] * v[39] + v[79] * v[40] + v[69] * v[31];
            v[81] = -1. * v[79] + 4.89663865010925e-12 * v[69];
            v[82] = -1. * v[80] + 4.89663865010925e-12 * v[81];
            v[83] = 0.333 + -0.316 * v[72] + 0.0825 * v[70] + -0.0825 * v[76] + 0.384 * v[73] +
                    0.088 * v[77] + 0.212 * v[82];
            v[84] = blend(0., 1., 0. - v[83]);
            v[83] = blend(0., 1., v[83] - 0.);
            v[83] = v[84] + v[83];
            v[84] = v[83] * 0.212;
            v[85] = v[84] * 4.89663865010925e-12;
            v[84] = v[84] * -1.;
            v[86] = v[83] * 0.088;
            v[87] = v[85] * 4.89663865010925e-12 + v[84] * v[31] + v[86] * v[35];
            v[85] = v[85] * -1. + v[84] * v[40] + v[86] * v[36];
            v[88] = v[84] * v[39] + v[86] * v[31];
            v[89] = v[87] * 4.89663865010925e-12 + v[85] * v[33] + v[88] * v[29];
            v[87] = v[83] * 0.384 + v[87] + v[85] * v[32] + v[88] * v[27];
            v[90] = v[83] * -0.0825 + v[85] * v[26] + v[88] * v[25];
            v[91] = v[89] * -1. + v[87] * v[23] + v[90] * v[19];
            v[92] = v[83] * 0.0825 + v[87] * v[22] + v[90] * v[14];
            y[15] = 0. -
                    (v[83] * -0.316 + (v[89] * 4.89663865010925e-12 + v[87] * v[14] + v[90] * v[18]) * -1. +
                     v[91] * v[16] + v[92] * v[12]) *
                        -1. * v[51] +
                    (v[91] * v[15] + v[92] * v[10]) * -1. * v[56];
            y[16] =
                0. -
                (v[91] * 4.89663865010925e-12 + v[92] * v[1] + v[91] * v[72] * 4.89663865010925e-12) * v[53] +
                (v[92] * 4.89663865010925e-12 + v[92] * v[72] * 4.89663865010925e-12 + v[91] * v[1] * -1.) *
                    v[43];
            y[17] = 0. - (v[87] * v[71] + v[90] * v[70] + v[87] * v[74] * 4.89663865010925e-12) * v[52] +
                    (v[90] * v[71] + v[90] * v[74] * 4.89663865010925e-12 + v[87] * v[70] * -1.) * v[49];
            y[18] =
                0. - (v[88] * v[76] + v[85] * v[78] * -1. + v[85] * v[73] * 4.89663865010925e-12) * v[50] +
                (v[88] * v[78] * -1. + v[88] * v[73] * 4.89663865010925e-12 + v[85] * v[76] * -1.) * v[47];
            y[19] = 0. - (v[84] * v[69] + v[86] * v[75] + v[84] * v[79] * 4.89663865010925e-12) * v[48] +
                    (v[86] * v[69] + v[86] * v[79] * 4.89663865010925e-12 + v[84] * v[75] * -1.) * v[45];
            v[86] = blend(v[82], -v[82], v[82] - 0.);
            v[84] = cos(x[6]);
            v[88] = sin(x[6]);
            v[85] = 4.89663865010925e-12 * v[88];
            v[90] = v[77] * v[84] + v[80] * v[85] + v[81] * v[88];
            v[87] = -v[88];
            v[92] = 4.89663865010925e-12 * v[84];
            v[91] = v[77] * v[87] + v[80] * v[92] + v[81] * v[84];
            v[89] = 0.70710678118623 * v[90] + 0.707106781186865 * v[91];
            v[83] = blend(v[89], -v[89], v[89] - 0.);
            v[93] = v[83] / v[86];
            v[94] = v[86] / v[83];
            v[95] = blend(1.5707963267949 - atan(v[94]), atan(v[93]), v[83] - v[86]);
            v[96] = blend(v[95], -v[95], v[89] - 0.);
            v[95] = blend(3.14159265358979 - v[95], -3.14159265358979 + v[95], v[89] - 0.);
            v[95] = blend(v[96], v[95], v[82] - 0.);
            v[96] = blend(0., 1., 0. - v[95]);
            v[95] = blend(0., 1., v[95] - 0.);
            v[95] = v[96] + v[95];
            v[96] = blend(v[95], 0., v[82] - 0.);
            v[97] = blend(v[96], 0., v[89] - 0.);
            v[96] = blend(0., v[96], v[89] - 0.);
            v[95] = blend(0., v[95], v[82] - 0.);
            v[98] = blend(0., v[95], v[89] - 0.);
            v[95] = blend(v[95], 0., v[89] - 0.);
            v[95] = v[97] + v[96] * -1. + v[98] - v[95];
            v[98] = blend(v[95], 0., v[83] - v[86]);
            v[98] = (0. - v[98]) * 1. / (1. + v[94] * v[94]) * 1. / v[83];
            v[95] = blend(0., v[95], v[83] - v[86]);
            v[95] = v[95] * 1. / (1. + v[93] * v[93]) * 1. / v[86];
            v[93] = v[98] - v[95] * v[93];
            v[86] = blend(v[93], 0., v[82] - 0.);
            v[93] = blend(0., v[93], v[82] - 0.);
            v[93] = v[86] + v[93] * -1.;
            v[95] = 0. - v[98] * v[94] + v[95];
            v[98] = blend(v[95], 0., v[89] - 0.);
            v[95] = blend(0., v[95], v[89] - 0.);
            v[95] = v[98] + v[95] * -1.;
            v[98] = v[95] * 0.707106781186865;
            v[95] = v[95] * 0.70710678118623;
            v[89] = v[93] * 4.89663865010925e-12 + v[98] * v[84] + v[95] * v[88];
            v[93] = v[93] * -1. + v[98] * v[92] + v[95] * v[85];
            v[94] = v[98] * v[87] + v[95] * v[84];
            v[86] = v[89] * 4.89663865010925e-12 + v[93] * v[31] + v[94] * v[35];
            v[89] = v[89] * -1. + v[93] * v[40] + v[94] * v[36];
            v[82] = v[93] * v[39] + v[94] * v[31];
            v[83] = v[86] * 4.89663865010925e-12 + v[89] * v[33] + v[82] * v[29];
            v[86] = v[86] + v[89] * v[32] + v[82] * v[27];
            v[96] = v[89] * v[26] + v[82] * v[25];
            v[97] = v[83] * -1. + v[86] * v[23] + v[96] * v[19];
            v[99] = v[86] * v[22] + v[96] * v[14];
            y[22] = 0. -
                    ((v[83] * 4.89663865010925e-12 + v[86] * v[14] + v[96] * v[18]) * -1. + v[97] * v[16] +
                     v[99] * v[12]) *
                        -1. * v[51] +
                    (v[97] * v[15] + v[99] * v[10]) * -1. * v[56];
            y[23] =
                0. -
                (v[97] * 4.89663865010925e-12 + v[99] * v[1] + v[97] * v[72] * 4.89663865010925e-12) * v[53] +
                (v[99] * 4.89663865010925e-12 + v[99] * v[72] * 4.89663865010925e-12 + v[97] * v[1] * -1.) *
                    v[43];
            y[24] = 0. - (v[86] * v[71] + v[96] * v[70] + v[86] * v[74] * 4.89663865010925e-12) * v[52] +
                    (v[96] * v[71] + v[96] * v[74] * 4.89663865010925e-12 + v[86] * v[70] * -1.) * v[49];
            y[25] =
                0. - (v[82] * v[76] + v[89] * v[78] * -1. + v[89] * v[73] * 4.89663865010925e-12) * v[50] +
                (v[82] * v[78] * -1. + v[82] * v[73] * 4.89663865010925e-12 + v[89] * v[76] * -1.) * v[47];
            y[26] = 0. - (v[93] * v[69] + v[94] * v[75] + v[93] * v[79] * 4.89663865010925e-12) * v[48] +
                    (v[94] * v[69] + v[94] * v[79] * 4.89663865010925e-12 + v[93] * v[75] * -1.) * v[45];
            v[94] = sin(x[6]);
            v[93] = cos(x[6]);
            y[27] = 0. - (v[98] * v[81] + v[95] * v[77] + v[98] * v[80] * 4.89663865010925e-12) * v[94] +
                    (v[95] * v[81] + v[95] * v[80] * 4.89663865010925e-12 + v[98] * v[77] * -1.) * v[93];
            v[91] = 0.707106781186865 * v[90] + -0.70710678118623 * v[91];
            v[90] = -asin(v[91]);
            v[95] = blend(0., 1., 0. - v[90]);
            v[90] = blend(0., 1., v[90] - 0.);
            v[90] = (v[95] + v[90]) * -1. * 1. / sqrt(1. - v[91] * v[91]);
            v[95] = v[90] * -0.70710678118623;
            v[90] = v[90] * 0.707106781186865;
            v[91] = v[95] * v[84] + v[90] * v[88];
            v[98] = v[95] * v[92] + v[90] * v[85];
            v[82] = v[95] * v[87] + v[90] * v[84];
            v[89] = v[91] * 4.89663865010925e-12 + v[98] * v[31] + v[82] * v[35];
            v[91] = v[91] * -1. + v[98] * v[40] + v[82] * v[36];
            v[96] = v[98] * v[39] + v[82] * v[31];
            v[86] = v[89] * 4.89663865010925e-12 + v[91] * v[33] + v[96] * v[29];
            v[89] = v[89] + v[91] * v[32] + v[96] * v[27];
            v[99] = v[91] * v[26] + v[96] * v[25];
            v[97] = v[86] * -1. + v[89] * v[23] + v[99] * v[19];
            v[83] = v[89] * v[22] + v[99] * v[14];
            y[29] = 0. -
                    ((v[86] * 4.89663865010925e-12 + v[89] * v[14] + v[99] * v[18]) * -1. + v[97] * v[16] +
                     v[83] * v[12]) *
                        -1. * v[51] +
                    (v[97] * v[15] + v[83] * v[10]) * -1. * v[56];
            y[30] =
                0. -
                (v[97] * 4.89663865010925e-12 + v[83] * v[1] + v[97] * v[72] * 4.89663865010925e-12) * v[53] +
                (v[83] * 4.89663865010925e-12 + v[83] * v[72] * 4.89663865010925e-12 + v[97] * v[1] * -1.) *
                    v[43];
            y[31] = 0. - (v[89] * v[71] + v[99] * v[70] + v[89] * v[74] * 4.89663865010925e-12) * v[52] +
                    (v[99] * v[71] + v[99] * v[74] * 4.89663865010925e-12 + v[89] * v[70] * -1.) * v[49];
            y[32] =
                0. - (v[96] * v[76] + v[91] * v[78] * -1. + v[91] * v[73] * 4.89663865010925e-12) * v[50] +
                (v[96] * v[78] * -1. + v[96] * v[73] * 4.89663865010925e-12 + v[91] * v[76] * -1.) * v[47];
            y[33] = 0. - (v[98] * v[69] + v[82] * v[75] + v[98] * v[79] * 4.89663865010925e-12) * v[48] +
                    (v[82] * v[69] + v[82] * v[79] * 4.89663865010925e-12 + v[98] * v[75] * -1.) * v[45];
            y[34] = 0. - (v[95] * v[81] + v[90] * v[77] + v[95] * v[80] * 4.89663865010925e-12) * v[94] +
                    (v[90] * v[81] + v[90] * v[80] * 4.89663865010925e-12 + v[95] * v[77] * -1.) * v[93];
            v[90] = 0.707106781186865 * (v[66] * v[84] + v[67] * v[85] + v[68] * v[88]) +
                    -0.70710678118623 * (v[66] * v[87] + v[67] * v[92] + v[68] * v[84]);
            v[95] = 0.707106781186865 * (v[38] * v[84] + v[41] * v[85] + v[42] * v[88]) +
                    -0.70710678118623 * (v[38] * v[87] + v[41] * v[92] + v[42] * v[84]);
            v[81] = blend(v[95], -v[95], v[95] - 0.);
            v[80] = blend(v[90], -v[90], v[90] - 0.);
            v[77] = v[80] / v[81];
            v[82] = v[81] / v[80];
            v[98] = blend(1.5707963267949 - atan(v[82]), atan(v[77]), v[80] - v[81]);
            v[69] = blend(v[98], -v[98], v[90] - 0.);
            v[98] = blend(3.14159265358979 - v[98], -3.14159265358979 + v[98], v[90] - 0.);
            v[98] = blend(v[69], v[98], v[95] - 0.);
            v[69] = blend(0., 1., 0. - v[98]);
            v[98] = blend(0., 1., v[98] - 0.);
            v[98] = v[69] + v[98];
            v[69] = blend(v[98], 0., v[95] - 0.);
            v[79] = blend(v[69], 0., v[90] - 0.);
            v[69] = blend(0., v[69], v[90] - 0.);
            v[98] = blend(0., v[98], v[95] - 0.);
            v[75] = blend(0., v[98], v[90] - 0.);
            v[98] = blend(v[98], 0., v[90] - 0.);
            v[98] = v[79] + v[69] * -1. + v[75] - v[98];
            v[75] = blend(v[98], 0., v[80] - v[81]);
            v[75] = (0. - v[75]) * 1. / (1. + v[82] * v[82]) * 1. / v[80];
            v[98] = blend(0., v[98], v[80] - v[81]);
            v[98] = v[98] * 1. / (1. + v[77] * v[77]) * 1. / v[81];
            v[82] = 0. - v[75] * v[82] + v[98];
            v[81] = blend(v[82], 0., v[90] - 0.);
            v[82] = blend(0., v[82], v[90] - 0.);
            v[82] = v[81] + v[82] * -1.;
            v[81] = v[82] * -0.70710678118623;
            v[82] = v[82] * 0.707106781186865;
            v[90] = v[81] * v[84] + v[82] * v[88];
            v[80] = v[81] * v[92] + v[82] * v[85];
            v[69] = v[81] * v[87] + v[82] * v[84];
            v[79] = v[90] * 4.89663865010925e-12 + v[80] * v[31] + v[69] * v[35];
            v[90] = v[90] * -1. + v[80] * v[40] + v[69] * v[36];
            v[96] = v[80] * v[39] + v[69] * v[31];
            v[91] = v[79] * 4.89663865010925e-12 + v[90] * v[33] + v[96] * v[29];
            v[79] = v[79] + v[90] * v[32] + v[96] * v[27];
            v[78] = v[90] * v[26] + v[96] * v[25];
            v[73] = v[91] * 4.89663865010925e-12 + v[79] * v[14] + v[78] * v[18];
            v[91] = v[91] * -1. + v[79] * v[23] + v[78] * v[19];
            v[76] = v[79] * v[22] + v[78] * v[14];
            v[99] = v[73] * -1. + v[91] * v[16] + v[76] * v[12];
            v[98] = v[75] - v[98] * v[77];
            v[75] = blend(v[98], 0., v[95] - 0.);
            v[98] = blend(0., v[98], v[95] - 0.);
            v[98] = v[75] + v[98] * -1.;
            v[75] = v[98] * -0.70710678118623;
            v[98] = v[98] * 0.707106781186865;
            v[88] = v[75] * v[84] + v[98] * v[88];
            v[92] = v[75] * v[92] + v[98] * v[85];
            v[87] = v[75] * v[87] + v[98] * v[84];
            v[35] = v[88] * 4.89663865010925e-12 + v[92] * v[31] + v[87] * v[35];
            v[88] = v[88] * -1. + v[92] * v[40] + v[87] * v[36];
            v[39] = v[92] * v[39] + v[87] * v[31];
            v[33] = v[35] * 4.89663865010925e-12 + v[88] * v[33] + v[39] * v[29];
            v[35] = v[35] + v[88] * v[32] + v[39] * v[27];
            v[26] = v[88] * v[26] + v[39] * v[25];
            v[18] = v[33] * 4.89663865010925e-12 + v[35] * v[14] + v[26] * v[18];
            v[33] = v[33] * -1. + v[35] * v[23] + v[26] * v[19];
            v[22] = v[35] * v[22] + v[26] * v[14];
            v[16] = v[18] * -1. + v[33] * v[16] + v[22] * v[12];
            v[12] = v[91] * v[15] + v[76] * v[10];
            v[15] = v[33] * v[15] + v[22] * v[10];
            y[35] = 0. -
                    (v[73] * 4.89663865010925e-12 + v[91] * v[10] + v[76] * v[11] + v[99] * v[6] +
                     v[16] * v[2] + v[12] * v[8] + v[15] * v[5]) *
                        v[54] +
                    (v[99] * v[2] + v[12] * v[5] +
                     (v[18] * 4.89663865010925e-12 + v[33] * v[10] + v[22] * v[11] + v[16] * v[6] +
                      v[15] * v[8]) *
                         -1.) *
                        v[55];
            y[36] =
                0. -
                (v[12] * v[3] + v[15] * v[0] + (v[99] * v[0] + v[16] * v[4]) * 4.89663865010925e-12) * v[51] +
                ((v[12] * v[0] + v[15] * v[4]) * 4.89663865010925e-12 + (v[99] * v[3] + v[16] * v[0]) * -1.) *
                    v[56];
            y[37] = 0. -
                    (v[91] * v[0] + v[33] * v[4] + v[76] * v[44] + v[22] * v[9] +
                     (v[91] * v[46] + v[33] * v[7]) * 4.89663865010925e-12) *
                        v[53] +
                    (v[76] * v[0] + v[22] * v[4] + (v[76] * v[46] + v[22] * v[7]) * 4.89663865010925e-12 +
                     (v[91] * v[44] + v[33] * v[9]) * -1.) *
                        v[43];
            y[38] = 0. -
                    (v[79] * v[59] + v[35] * v[20] + v[78] * v[57] + v[26] * v[13] +
                     (v[79] * v[58] + v[35] * v[17]) * 4.89663865010925e-12) *
                        v[52] +
                    (v[78] * v[59] + v[26] * v[20] + (v[78] * v[58] + v[26] * v[17]) * 4.89663865010925e-12 +
                     (v[79] * v[57] + v[35] * v[13]) * -1.) *
                        v[49];
            y[39] = 0. -
                    (v[96] * v[60] + v[39] * v[21] + (v[90] * v[62] + v[88] * v[28]) * -1. +
                     (v[90] * v[61] + v[88] * v[24]) * 4.89663865010925e-12) *
                        v[50] +
                    ((v[96] * v[62] + v[39] * v[28]) * -1. +
                     (v[96] * v[61] + v[39] * v[24]) * 4.89663865010925e-12 +
                     (v[90] * v[60] + v[88] * v[21]) * -1.) *
                        v[47];
            y[40] = 0. -
                    (v[80] * v[65] + v[92] * v[37] + v[69] * v[63] + v[87] * v[30] +
                     (v[80] * v[64] + v[92] * v[34]) * 4.89663865010925e-12) *
                        v[48] +
                    (v[69] * v[65] + v[87] * v[37] + (v[69] * v[64] + v[87] * v[34]) * 4.89663865010925e-12 +
                     (v[80] * v[63] + v[92] * v[30]) * -1.) *
                        v[45];
            y[41] = 0. -
                    (v[81] * v[68] + v[75] * v[42] + v[82] * v[66] + v[98] * v[38] +
                     (v[81] * v[67] + v[75] * v[41]) * 4.89663865010925e-12) *
                        v[94] +
                    (v[82] * v[68] + v[98] * v[42] + (v[82] * v[67] + v[98] * v[41]) * 4.89663865010925e-12 +
                     (v[81] * v[66] + v[75] * v[38]) * -1.) *
                        v[93];
            v[98] = 2. * x[16];
            v[75] = v[98] * x[16];
            v[82] = 2. * x[17];
            ...
            v[69] = -v[92];
            v[80] = cos(x[1]);
            v[65] = 4.89663865010925e-12 * v[80];
            v[64] = v[41] * v[87] + v[69] * v[65];
            v[63] = 4.89663865010925e-12 * v[38];
            v[45] = v[41] * v[80] + v[69] * v[63];
            v[48] = cos(x[2]);
            v[37] = sin(x[2]);
            v[34] = 4.89663865010925e-12 * v[37];
            v[30] = v[45] * v[48] + v[64] * v[34] + v[69] * v[37];
            v[39] = cos(x[3]);
            v[88] = -v[37];
            v[96] = 4.89663865010925e-12 * v[48];
            v[45] = v[45] * v[88] + v[64] * v[96] + v[69] * v[48];
            v[90] = sin(x[3]);
            v[62] = 4.89663865010925e-12 * v[90];
            v[69] = -1. * v[64] + 4.89663865010925e-12 * v[69];
            v[61] = v[30] * v[39] + v[45] * v[62] + v[69] * v[90];
            v[60] = -v[90];
            v[47] = 4.89663865010925e-12 * v[39];
            v[50] = v[30] * v[60] + v[45] * v[47] + v[69] * v[39];
            v[28] = cos(x[4]);
            v[24] = sin(x[4]);
            v[21] = 4.89663865010925e-12 * v[24];
            v[69] = -1. * v[45] + 4.89663865010925e-12 * v[69];
            v[45] = -1. * v[24];
            v[26] = v[61] * v[28] + v[50] * v[21] + v[69] * v[45];
            v[35] = cos(x[5]);
            v[24] = -v[24];
            v[78] = 4.89663865010925e-12 * v[28];
            v[79] = -1. * v[28];
            v[59] = v[61] * v[24] + v[50] * v[78] + v[69] * v[79];
            v[58] = sin(x[5]);
            v[57] = 4.89663865010925e-12 * v[58];
            v[69] = v[50] + 4.89663865010925e-12 * v[69];
            v[49] = v[26] * v[35] + v[59] * v[57] + v[69] * v[58];
            v[52] = -v[58];
            v[20] = 4.89663865010925e-12 * v[35];
            v[26] = v[26] * v[52] + v[59] * v[20] + v[69] * v[35];
            v[69] = -1. * v[59] + 4.89663865010925e-12 * v[69];
            v[59] = -1. * v[26] + 4.89663865010925e-12 * v[69];
            v[17] = cos(x[6]);
            v[13] = sin(x[6]);
            v[22] = 4.89663865010925e-12 * v[13];
            v[33] = v[49] * v[17] + v[26] * v[22] + v[69] * v[13];
            v[76] = -v[13];
            v[91] = 4.89663865010925e-12 * v[17];
            v[69] = v[49] * v[76] + v[26] * v[91] + v[69] * v[17];
            v[26] = 0.707106781186865 * v[33] + -0.70710678118623 * v[69];
            v[44] = 2. * x[9];
            v[46] = v[44] * x[9];
            v[43] = 2. * x[10];
            v[53] = v[43] * x[10];
            ...
            v[44] = v[44] * x[7];
            v[12] = v[15] - v[44];
            v[16] = (-v[9]) * x[11] + (-v[0]) * x[12] + (-v[12]) * x[13];
            v[69] = 0.70710678118623 * v[33] + 0.707106781186865 * v[69];
            v[4] = v[7] - v[4];
            v[7] = 2. * x[8];
            v[33] = v[7] * x[8];
            v[53] = 1. - (v[33] + v[53]);
            ...
            v[7] = v[7] * x[7];
            v[99] = v[43] + v[7];
            v[56] = (-v[4]) * x[11] + (-v[53]) * x[12] + (-v[99]) * x[13];
            v[44] = v[15] + v[44];
            v[7] = v[43] - v[7];
            v[33] = 1. - (v[33] + v[46]);
            v[46] = (-v[44]) * x[11] + (-v[7]) * x[12] + (-v[33]) * x[13];
            v[49] = -0.316 * v[64] + 0.0825 * v[30] + -0.0825 * v[61] + 0.384 * v[50] + 0.088 * v[49] +
                    0.212 * v[59] + v[26] * v[16] + v[69] * v[56] + v[59] * v[46];
            v[65] = v[92] * v[87] + v[41] * v[65];
            v[63] = v[92] * v[80] + v[41] * v[63];
            v[92] = v[63] * v[48] + v[65] * v[34] + v[41] * v[37];
            v[63] = v[63] * v[88] + v[65] * v[96] + v[41] * v[48];
            v[41] = -1. * v[65] + 4.89663865010925e-12 * v[41];
            v[87] = v[92] * v[39] + v[63] * v[62] + v[41] * v[90];
            v[50] = v[92] * v[60] + v[63] * v[47] + v[41] * v[39];
            v[41] = -1. * v[63] + 4.89663865010925e-12 * v[41];
            v[63] = v[87] * v[28] + v[50] * v[21] + v[41] * v[45];
            v[61] = v[87] * v[24] + v[50] * v[78] + v[41] * v[79];
            v[41] = v[50] + 4.89663865010925e-12 * v[41];
            v[30] = v[63] * v[35] + v[61] * v[57] + v[41] * v[58];
            v[63] = v[63] * v[52] + v[61] * v[20] + v[41] * v[35];
            v[41] = -1. * v[61] + 4.89663865010925e-12 * v[41];
            v[61] = -1. * v[63] + 4.89663865010925e-12 * v[41];
            v[64] = v[30] * v[17] + v[63] * v[22] + v[41] * v[13];
            v[41] = v[30] * v[76] + v[63] * v[91] + v[41] * v[17];
            v[63] = 0.707106781186865 * v[64] + -0.70710678118623 * v[41];
            v[41] = 0.70710678118623 * v[64] + 0.707106781186865 * v[41];
            v[30] = -0.316 * v[65] + 0.0825 * v[92] + -0.0825 * v[87] + 0.384 * v[50] + 0.088 * v[30] +
                    0.212 * v[61] + v[63] * v[16] + v[41] * v[56] + v[61] * v[46];
            v[80] = -1. * v[80];
            v[38] = -1. * v[38];
            v[34] = v[38] * v[48] + v[80] * v[34] + 4.89663865010925e-12 * v[37];
            v[38] = v[38] * v[88] + v[80] * v[96] + 4.89663865010925e-12 * v[48];
            v[96] = 2.39770700697438e-23 + -1. * v[80];
            v[62] = v[34] * v[39] + v[38] * v[62] + v[96] * v[90];
            v[47] = v[34] * v[60] + v[38] * v[47] + v[96] * v[39];
            v[96] = -1. * v[38] + 4.89663865010925e-12 * v[96];
            v[45] = v[62] * v[28] + v[47] * v[21] + v[96] * v[45];
            v[79] = v[62] * v[24] + v[47] * v[78] + v[96] * v[79];
            v[96] = v[47] + 4.89663865010925e-12 * v[96];
            v[57] = v[45] * v[35] + v[79] * v[57] + v[96] * v[58];
            v[45] = v[45] * v[52] + v[79] * v[20] + v[96] * v[35];
            v[96] = -1. * v[79] + 4.89663865010925e-12 * v[96];
            v[79] = -1. * v[45] + 4.89663865010925e-12 * v[96];
            v[22] = v[57] * v[17] + v[45] * v[22] + v[96] * v[13];
            v[96] = v[57] * v[76] + v[45] * v[91] + v[96] * v[17];
            v[45] = 0.707106781186865 * v[22] + -0.70710678118623 * v[96];
            v[96] = 0.70710678118623 * v[22] + 0.707106781186865 * v[96];
            v[57] = 0.333 + -0.316 * v[80] + 0.0825 * v[34] + -0.0825 * v[62] + 0.384 * v[47] +
                    0.088 * v[57] + 0.212 * v[79] + v[45] * v[16] + v[96] * v[56] + v[79] * v[46];
            v[47] = (-v[93]) * x[18] + (-v[67]) * x[19] + (-v[42]) * x[20] + v[93] * v[49] + v[67] * v[30] +
                    v[42] * v[57];
            v[62] = blend(0., v[47] - x[21], v[47] - x[21]);
            v[47] = blend(0., v[47] - x[27], x[27] - v[47]);
            y[42] = v[62] + v[47];
            v[68] = v[94] - v[68];
            v[94] = 2. * x[15];
            v[47] = v[94] * x[15];
            ...
            v[94] = v[94] * x[14];
            v[62] = v[82] + v[94];
            v[34] = (-v[68]) * x[18] + (-v[81]) * x[19] + (-v[62]) * x[20] + v[68] * v[49] + v[81] * v[30] +
                    v[62] * v[57];
            v[80] = blend(0., v[34] - x[22], v[34] - x[22]);
            v[34] = blend(0., v[34] - x[28], x[28] - v[34]);
            y[43] = v[80] + v[34];
            v[98] = v[66] + v[98];
            v[94] = v[82] - v[94];
            v[47] = 1. - (v[47] + v[75]);
            v[57] = (-v[98]) * x[18] + (-v[94]) * x[19] + (-v[47]) * x[20] + v[98] * v[49] + v[94] * v[30] +
                    v[47] * v[57];
            v[30] = blend(0., v[57] - x[23], v[57] - x[23]);
            v[57] = blend(0., v[57] - x[29], x[29] - v[57]);
            y[44] = v[30] + v[57];
            v[33] = v[98] * (v[26] * v[12] + v[69] * v[99] + v[59] * v[33]) +
                    v[94] * (v[63] * v[12] + v[41] * v[99] + v[61] * v[33]) +
                    v[47] * (v[45] * v[12] + v[96] * v[99] + v[79] * v[33]);
            v[7] = v[98] * (v[26] * v[0] + v[69] * v[53] + v[59] * v[7]) +
                   v[94] * (v[63] * v[0] + v[41] * v[53] + v[61] * v[7]) +
                   v[47] * (v[45] * v[0] + v[96] * v[53] + v[79] * v[7]);
            v[53] = blend(v[33], -v[33], v[33] - 0.);
            v[0] = blend(v[7], -v[7], v[7] - 0.);
            v[0] = blend(1.5707963267949 - atan(v[53] / v[0]), atan(v[0] / v[53]), v[0] - v[53]);
            v[53] = blend(v[0], -v[0], v[7] - 0.);
            v[0] = blend(3.14159265358979 - v[0], -3.14159265358979 + v[0], v[7] - 0.);
            v[0] = blend(v[53], v[0], v[33] - 0.);
            v[53] = blend(0., v[0] - x[24], v[0] - x[24]);
            v[0] = blend(0., v[0] - x[30], x[30] - v[0]);
            y[45] = v[53] + v[0];
            v[69] = v[26] * v[9] + v[69] * v[4] + v[59] * v[44];
            v[41] = v[63] * v[9] + v[41] * v[4] + v[61] * v[44];
            v[96] = v[45] * v[9] + v[96] * v[4] + v[79] * v[44];
            v[47] = -asin(v[98] * v[69] + v[94] * v[41] + v[47] * v[96]);
            v[94] = blend(0., v[47] - x[25], v[47] - x[25]);
            v[47] = blend(0., v[47] - x[31], x[31] - v[47]);
            y[46] = v[94] + v[47];
            v[42] = v[93] * v[69] + v[67] * v[41] + v[42] * v[96];
            v[96] = v[68] * v[69] + v[81] * v[41] + v[62] * v[96];
            v[41] = blend(v[42], -v[42], v[42] - 0.);
            v[69] = blend(v[96], -v[96], v[96] - 0.);
            v[69] = blend(1.5707963267949 - atan(v[41] / v[69]), atan(v[69] / v[41]), v[69] - v[41]);
            v[41] = blend(v[69], -v[69], v[96] - 0.);
            v[69] = blend(3.14159265358979 - v[69], -3.14159265358979 + v[69], v[96] - 0.);
            v[69] = blend(v[41], v[69], v[42] - 0.);
            v[41] = blend(0., v[69] - x[26], v[69] - x[26]);
            v[69] = blend(0., v[69] - x[32], x[32] - v[69]);
            y[47] = v[41] + v[69];
            // dependent variables without operations
            y[6] = 0.;
            y[13] = 0.;
...
template <typename InputVector, typename OutputVector>
static inline auto tsr_function_gradient(const InputVector &x, OutputVector &out) noexcept {
            ...
            v[5] = 4.89663865010925e-12 * v[4];
            v[6] = v[0] * v[2] + v[3] * v[5];
            v[7] = 4.89663865010925e-12 * v[1];
            v[8] = v[0] * v[4] + v[3] * v[7];
            v[9] = cos(x[2]);
            v[10] = sin(x[2]);
            v[11] = 4.89663865010925e-12 * v[10];
            v[12] = v[8] * v[9] + v[6] * v[11] + v[3] * v[10];
            v[13] = cos(x[3]);
            v[14] = -v[10];
            v[15] = 4.89663865010925e-12 * v[9];
            v[16] = v[8] * v[14] + v[6] * v[15] + v[3] * v[9];
            v[17] = sin(x[3]);
            v[18] = 4.89663865010925e-12 * v[17];
            v[19] = -1. * v[6] + 4.89663865010925e-12 * v[3];
            v[20] = v[12] * v[13] + v[16] * v[18] + v[19] * v[17];
            v[21] = -v[17];
            v[22] = 4.89663865010925e-12 * v[13];
            v[23] = v[12] * v[21] + v[16] * v[22] + v[19] * v[13];
            v[24] = cos(x[4]);
            v[25] = sin(x[4]);
            v[26] = 4.89663865010925e-12 * v[25];
            v[27] = -1. * v[16] + 4.89663865010925e-12 * v[19];
            v[28] = -1. * v[25];
            v[29] = v[20] * v[24] + v[23] * v[26] + v[27] * v[28];
            v[30] = cos(x[5]);
            v[25] = -v[25];
            v[31] = 4.89663865010925e-12 * v[24];
            v[32] = -1. * v[24];
            v[33] = v[20] * v[25] + v[23] * v[31] + v[27] * v[32];
            v[34] = sin(x[5]);
            v[35] = 4.89663865010925e-12 * v[34];
            v[36] = v[23] + 4.89663865010925e-12 * v[27];
            v[37] = v[29] * v[30] + v[33] * v[35] + v[36] * v[34];
            v[38] = -v[34];
            v[39] = 4.89663865010925e-12 * v[30];
            v[40] = v[29] * v[38] + v[33] * v[39] + v[36] * v[30];
            v[41] = -1. * v[33] + 4.89663865010925e-12 * v[36];
            v[42] = -1. * v[40] + 4.89663865010925e-12 * v[41];
            v[43] = -0.316 * v[6] + 0.0825 * v[12] + -0.0825 * v[20] + 0.384 * v[23] + 0.088 * v[37] +
                    0.212 * v[42];
            v[44] = blend(v[43], 0., 0. - v[43]);
            v[45] = blend(v[43], 0., v[43] - 0.);
            v[45] = v[44] + v[45];
            v[45] = v[45] + v[45];
            v[44] = blend(v[45], 0., 0. - v[43]);
            v[45] = blend(v[45], 0., v[43] - 0.);
            v[43] = v[44] + v[45];
            v[46] = v[43] * 0.212;
            v[47] = v[46] * 4.89663865010925e-12;
            v[46] = v[46] * -1.;
            v[48] = v[43] * 0.088;
            v[49] = v[47] * 4.89663865010925e-12 + v[46] * v[30] + v[48] * v[34];
            v[47] = v[47] * -1. + v[46] * v[39] + v[48] * v[35];
            v[50] = v[46] * v[38] + v[48] * v[30];
            v[51] = v[49] * 4.89663865010925e-12 + v[47] * v[32] + v[50] * v[28];
            v[49] = v[43] * 0.384 + v[49] + v[47] * v[31] + v[50] * v[26];
            v[52] = v[43] * -0.0825 + v[47] * v[25] + v[50] * v[24];
            v[53] = v[51] * 4.89663865010925e-12 + v[49] * v[13] + v[52] * v[17];
            v[51] = v[51] * -1. + v[49] * v[22] + v[52] * v[18];
            v[54] = v[43] * 0.0825 + v[49] * v[21] + v[52] * v[13];
            v[55] = v[43] * -0.316 + v[53] * -1. + v[51] * v[15] + v[54] * v[11];
            v[56] = -v[0];
            v[57] = v[3] * v[2] + v[56] * v[5];
            v[58] = v[3] * v[4] + v[56] * v[7];
            v[59] = v[58] * v[9] + v[57] * v[11] + v[56] * v[10];
            v[60] = v[58] * v[14] + v[57] * v[15] + v[56] * v[9];
            v[61] = -1. * v[57] + 4.89663865010925e-12 * v[56];
            v[62] = v[59] * v[13] + v[60] * v[18] + v[61] * v[17];
            v[63] = v[59] * v[21] + v[60] * v[22] + v[61] * v[13];
            v[64] = -1. * v[60] + 4.89663865010925e-12 * v[61];
            v[65] = v[62] * v[24] + v[63] * v[26] + v[64] * v[28];
            v[66] = v[62] * v[25] + v[63] * v[31] + v[64] * v[32];
            v[67] = v[63] + 4.89663865010925e-12 * v[64];
            v[68] = v[65] * v[30] + v[66] * v[35] + v[67] * v[34];
            v[69] = v[65] * v[38] + v[66] * v[39] + v[67] * v[30];
            v[70] = -1. * v[66] + 4.89663865010925e-12 * v[67];
            v[71] = -1. * v[69] + 4.89663865010925e-12 * v[70];
            v[72] = -0.316 * v[57] + 0.0825 * v[59] + -0.0825 * v[62] + 0.384 * v[63] + 0.088 * v[68] +
                    0.212 * v[71];
            v[73] = blend(v[72], 0., 0. - v[72]);
            v[74] = blend(v[72], 0., v[72] - 0.);
            v[74] = v[73] + v[74];
            v[74] = v[74] + v[74];
            v[73] = blend(v[74], 0., 0. - v[72]);
            v[74] = blend(v[74], 0., v[72] - 0.);
            v[72] = v[73] + v[74];
            v[75] = v[72] * 0.212;
            v[76] = v[75] * 4.89663865010925e-12;
            v[75] = v[75] * -1.;
            v[77] = v[72] * 0.088;
            v[78] = v[76] * 4.89663865010925e-12 + v[75] * v[30] + v[77] * v[34];
            v[76] = v[76] * -1. + v[75] * v[39] + v[77] * v[35];
            v[79] = v[75] * v[38] + v[77] * v[30];
            v[80] = v[78] * 4.89663865010925e-12 + v[76] * v[32] + v[79] * v[28];
            v[78] = v[72] * 0.384 + v[78] + v[76] * v[31] + v[79] * v[26];
            v[81] = v[72] * -0.0825 + v[76] * v[25] + v[79] * v[24];
            v[82] = v[80] * 4.89663865010925e-12 + v[78] * v[13] + v[81] * v[17];
            v[80] = v[80] * -1. + v[78] * v[22] + v[81] * v[18];
            v[83] = v[72] * 0.0825 + v[78] * v[21] + v[81] * v[13];
            v[84] = v[72] * -0.316 + v[82] * -1. + v[80] * v[15] + v[83] * v[11];
            v[85] = v[51] * v[14] + v[54] * v[9];
            v[86] = v[80] * v[14] + v[83] * v[9];
            y[0] =
                0. -
                (v[53] * 4.89663865010925e-12 + v[51] * v[9] + v[54] * v[10] + v[55] * v[5] + v[84] * v[2] +
                 v[85] * v[7] + v[86] * v[4]) *
                    sin(x[0]) +
                (v[55] * v[2] + v[85] * v[4] +
                 (v[82] * 4.89663865010925e-12 + v[80] * v[9] + v[83] * v[10] + v[84] * v[5] + v[86] * v[7]) *
                     -1.) *
                    cos(x[0]);
            v[4] = -1. * v[4];
            v[1] = -1. * v[1];
            v[10] = v[1] * v[9] + v[4] * v[11] + 4.89663865010925e-12 * v[10];
            v[82] = v[1] * v[14] + v[4] * v[15] + 4.89663865010925e-12 * v[9];
            v[53] = 2.39770700697438e-23 + -1. * v[4];
            v[7] = v[10] * v[13] + v[82] * v[18] + v[53] * v[17];
            v[5] = v[10] * v[21] + v[82] * v[22] + v[53] * v[13];
            v[2] = -1. * v[82] + 4.89663865010925e-12 * v[53];
            v[87] = v[7] * v[24] + v[5] * v[26] + v[2] * v[28];
            v[88] = v[7] * v[25] + v[5] * v[31] + v[2] * v[32];
            v[89] = v[5] + 4.89663865010925e-12 * v[2];
            v[90] = v[87] * v[30] + v[88] * v[35] + v[89] * v[34];
            v[91] = v[87] * v[38] + v[88] * v[39] + v[89] * v[30];
            v[92] = -1. * v[88] + 4.89663865010925e-12 * v[89];
            v[93] = -1. * v[91] + 4.89663865010925e-12 * v[92];
            v[94] = 0.333 + -0.316 * v[4] + 0.0825 * v[10] + -0.0825 * v[7] + 0.384 * v[5] + 0.088 * v[90] +
                    0.212 * v[93];
            v[95] = blend(v[94], 0., 0. - v[94]);
            v[96] = blend(v[94], 0., v[94] - 0.);
            v[96] = v[95] + v[96];
            v[96] = v[96] + v[96];
            v[95] = blend(v[96], 0., 0. - v[94]);
            v[96] = blend(v[96], 0., v[94] - 0.);
            v[94] = v[95] + v[96];
            v[97] = v[94] * 0.212;
            v[98] = v[97] * 4.89663865010925e-12;
            v[97] = v[97] * -1.;
            v[99] = v[94] * 0.088;
            v[34] = v[98] * 4.89663865010925e-12 + v[97] * v[30] + v[99] * v[34];
            v[98] = v[98] * -1. + v[97] * v[39] + v[99] * v[35];
            v[38] = v[97] * v[38] + v[99] * v[30];
            v[32] = v[34] * 4.89663865010925e-12 + v[98] * v[32] + v[38] * v[28];
            v[34] = v[94] * 0.384 + v[34] + v[98] * v[31] + v[38] * v[26];
            v[25] = v[94] * -0.0825 + v[98] * v[25] + v[38] * v[24];
            v[22] = v[32] * -1. + v[34] * v[22] + v[25] * v[18];
            v[21] = v[94] * 0.0825 + v[34] * v[21] + v[25] * v[13];
            y[1] = 0. -
                   (v[85] * v[0] + v[86] * v[3] +
                    (v[94] * -0.316 + (v[32] * 4.89663865010925e-12 + v[34] * v[13] + v[25] * v[17]) * -1. +
                     v[22] * v[15] + v[21] * v[11]) *
                        -1. +
                    (v[55] * v[3] + v[84] * v[56]) * 4.89663865010925e-12) *
                       sin(x[1]) +
                   ((v[22] * v[14] + v[21] * v[9]) * -1. +
                    (v[85] * v[3] + v[86] * v[56]) * 4.89663865010925e-12 +
                    (v[55] * v[0] + v[84] * v[3]) * -1.) *
                       cos(x[1]);
            y[2] =
                0. -
                (v[22] * 4.89663865010925e-12 + v[51] * v[3] + v[80] * v[56] + v[21] * v[1] + v[54] * v[8] +
                 v[83] * v[58] + (v[22] * v[4] + v[51] * v[6] + v[80] * v[57]) * 4.89663865010925e-12) *
                    sin(x[2]) +
                (v[21] * 4.89663865010925e-12 + v[54] * v[3] + v[83] * v[56] +
                 (v[21] * v[4] + v[54] * v[6] + v[83] * v[57]) * 4.89663865010925e-12 +
                 (v[22] * v[1] + v[51] * v[8] + v[80] * v[58]) * -1.) *
                    cos(x[2]);
            y[3] = 0. -
                   (v[34] * v[53] + v[49] * v[19] + v[78] * v[61] + v[25] * v[10] + v[52] * v[12] +
                    v[81] * v[59] + (v[34] * v[82] + v[49] * v[16] + v[78] * v[60]) * 4.89663865010925e-12) *
                       sin(x[3]) +
                   (v[25] * v[53] + v[52] * v[19] + v[81] * v[61] +
                    (v[25] * v[82] + v[52] * v[16] + v[81] * v[60]) * 4.89663865010925e-12 +
                    (v[34] * v[10] + v[49] * v[12] + v[78] * v[59]) * -1.) *
                       cos(x[3]);
            y[4] = 0. -
                   (v[38] * v[7] + v[50] * v[20] + v[79] * v[62] +
                    (v[98] * v[2] + v[47] * v[27] + v[76] * v[64]) * -1. +
                    (v[98] * v[5] + v[47] * v[23] + v[76] * v[63]) * 4.89663865010925e-12) *
                       sin(x[4]) +
                   ((v[38] * v[2] + v[50] * v[27] + v[79] * v[64]) * -1. +
                    (v[38] * v[5] + v[50] * v[23] + v[79] * v[63]) * 4.89663865010925e-12 +
                    (v[98] * v[7] + v[47] * v[20] + v[76] * v[62]) * -1.) *
                       cos(x[4]);
            y[5] = 0. -
                   (v[97] * v[89] + v[46] * v[36] + v[75] * v[67] + v[99] * v[87] + v[48] * v[29] +
                    v[77] * v[65] + (v[97] * v[88] + v[46] * v[33] + v[75] * v[66]) * 4.89663865010925e-12) *
                       sin(x[5]) +
                   (v[99] * v[89] + v[48] * v[36] + v[77] * v[67] +
                    (v[99] * v[88] + v[48] * v[33] + v[77] * v[66]) * 4.89663865010925e-12 +
                    (v[97] * v[87] + v[46] * v[29] + v[75] * v[65]) * -1.) *
                       cos(x[5]);
            v[99] = cos(x[6]);
            v[97] = sin(x[6]);
            v[89] = 4.89663865010925e-12 * v[97];
            v[88] = v[90] * v[99] + v[91] * v[89] + v[92] * v[97];
            v[87] = -v[97];
            v[77] = 4.89663865010925e-12 * v[99];
            v[92] = v[90] * v[87] + v[91] * v[77] + v[92] * v[99];
            v[91] = v[37] * v[99] + v[40] * v[89] + v[41] * v[97];
            v[41] = v[37] * v[87] + v[40] * v[77] + v[41] * v[99];
            v[89] = v[68] * v[99] + v[69] * v[89] + v[70] * v[97];
            v[77] = v[68] * v[87] + v[69] * v[77] + v[70] * v[99];
            y[11] = (v[94] * (0.707106781186865 * v[88] + -0.70710678118623 * v[92]) +
                     v[43] * (0.707106781186865 * v[91] + -0.70710678118623 * v[41]) +
                     v[72] * (0.707106781186865 * v[89] + -0.70710678118623 * v[77])) *
                    -1.;
            y[12] = (v[94] * (0.70710678118623 * v[88] + 0.707106781186865 * v[92]) +
                     v[43] * (0.70710678118623 * v[91] + 0.707106781186865 * v[41]) +
                     v[72] * (0.70710678118623 * v[89] + 0.707106781186865 * v[77])) *
                    -1.;
            y[13] = (v[94] * v[93] + v[43] * v[42] + v[72] * v[71]) * -1.;
            y[18] = v[72] * -1.;
            y[19] = v[43] * -1.;
            y[20] = v[94] * -1.;
            y[21] = 0. - v[73];
            ...
            v[41] = -v[89];
            v[91] = cos(x[1]);
            v[92] = 4.89663865010925e-12 * v[91];
            v[88] = v[71] * v[77] + v[41] * v[92];
            v[87] = 4.89663865010925e-12 * v[42];
            v[99] = v[71] * v[91] + v[41] * v[87];
            v[70] = cos(x[2]);
            v[69] = sin(x[2]);
            v[68] = 4.89663865010925e-12 * v[69];
            v[97] = v[99] * v[70] + v[88] * v[68] + v[41] * v[69];
            v[40] = cos(x[3]);
            v[37] = -v[69];
            v[90] = 4.89663865010925e-12 * v[70];
            v[99] = v[99] * v[37] + v[88] * v[90] + v[41] * v[70];
            v[75] = sin(x[3]);
            v[67] = 4.89663865010925e-12 * v[75];
            v[41] = -1. * v[88] + 4.89663865010925e-12 * v[41];
            v[66] = v[97] * v[40] + v[99] * v[67] + v[41] * v[75];
            v[65] = -v[75];
            v[48] = 4.89663865010925e-12 * v[40];
            v[46] = v[97] * v[65] + v[99] * v[48] + v[41] * v[40];
            v[36] = cos(x[4]);
            v[33] = sin(x[4]);
            v[29] = 4.89663865010925e-12 * v[33];
            v[41] = -1. * v[99] + 4.89663865010925e-12 * v[41];
            v[99] = -1. * v[33];
            v[38] = v[66] * v[36] + v[46] * v[29] + v[41] * v[99];
            v[98] = cos(x[5]);
            v[33] = -v[33];
            v[2] = 4.89663865010925e-12 * v[36];
            v[5] = -1. * v[36];
            v[7] = v[66] * v[33] + v[46] * v[2] + v[41] * v[5];
            v[79] = sin(x[5]);
            v[76] = 4.89663865010925e-12 * v[79];
            v[41] = v[46] + 4.89663865010925e-12 * v[41];
            v[64] = v[38] * v[98] + v[7] * v[76] + v[41] * v[79];
            v[63] = -v[79];
            v[62] = 4.89663865010925e-12 * v[98];
            v[38] = v[38] * v[63] + v[7] * v[62] + v[41] * v[98];
            v[41] = -1. * v[7] + 4.89663865010925e-12 * v[41];
            v[7] = -1. * v[38] + 4.89663865010925e-12 * v[41];
            v[50] = cos(x[6]);
            v[47] = sin(x[6]);
            v[27] = 4.89663865010925e-12 * v[47];
            v[23] = v[64] * v[50] + v[38] * v[27] + v[41] * v[47];
            v[20] = -v[47];
            v[25] = 4.89663865010925e-12 * v[50];
            v[41] = v[64] * v[20] + v[38] * v[25] + v[41] * v[50];
            v[38] = 2. * x[9];
            v[34] = v[38] * x[9];
            v[53] = 2. * x[10];
            v[82] = v[53] * x[10];
            ...
            v[38] = v[38] * x[7];
            v[61] =
                (-(1. - (v[34] + v[82]))) * x[11] + (-(v[10] + v[81])) * x[12] + (-(v[78] - v[38])) * x[13];
            v[60] = 2. * x[8];
            v[59] = v[60] * x[8];
            v[53] = v[53] * x[9];
            v[60] = v[60] * x[7];
            v[81] =
                (-(v[10] - v[81])) * x[11] + (-(1. - (v[59] + v[82]))) * x[12] + (-(v[53] + v[60])) * x[13];
            v[60] =
                (-(v[78] + v[38])) * x[11] + (-(v[53] - v[60])) * x[12] + (-(1. - (v[59] + v[34]))) * x[13];
            v[41] = -0.316 * v[88] + 0.0825 * v[97] + -0.0825 * v[66] + 0.384 * v[46] + 0.088 * v[64] +
                    0.212 * v[7] + (0.707106781186865 * v[23] + -0.70710678118623 * v[41]) * v[61] +
                    (0.70710678118623 * v[23] + 0.707106781186865 * v[41]) * v[81] + v[7] * v[60];
            v[92] = v[89] * v[77] + v[71] * v[92];
            v[87] = v[89] * v[91] + v[71] * v[87];
            v[89] = v[87] * v[70] + v[92] * v[68] + v[71] * v[69];
            v[87] = v[87] * v[37] + v[92] * v[90] + v[71] * v[70];
            v[71] = -1. * v[92] + 4.89663865010925e-12 * v[71];
            v[77] = v[89] * v[40] + v[87] * v[67] + v[71] * v[75];
            v[23] = v[89] * v[65] + v[87] * v[48] + v[71] * v[40];
            v[71] = -1. * v[87] + 4.89663865010925e-12 * v[71];
            v[87] = v[77] * v[36] + v[23] * v[29] + v[71] * v[99];
            v[7] = v[77] * v[33] + v[23] * v[2] + v[71] * v[5];
            v[71] = v[23] + 4.89663865010925e-12 * v[71];
            v[64] = v[87] * v[98] + v[7] * v[76] + v[71] * v[79];
            v[87] = v[87] * v[63] + v[7] * v[62] + v[71] * v[98];
            v[71] = -1. * v[7] + 4.89663865010925e-12 * v[71];
            v[7] = -1. * v[87] + 4.89663865010925e-12 * v[71];
            v[46] = v[64] * v[50] + v[87] * v[27] + v[71] * v[47];
            v[71] = v[64] * v[20] + v[87] * v[25] + v[71] * v[50];
            v[71] = -0.316 * v[92] + 0.0825 * v[89] + -0.0825 * v[77] + 0.384 * v[23] + 0.088 * v[64] +
                    0.212 * v[7] + (0.707106781186865 * v[46] + -0.70710678118623 * v[71]) * v[61] +
                    (0.70710678118623 * v[46] + 0.707106781186865 * v[71]) * v[81] + v[7] * v[60];
            v[91] = -1. * v[91];
            v[42] = -1. * v[42];
            v[68] = v[42] * v[70] + v[91] * v[68] + 4.89663865010925e-12 * v[69];
            v[42] = v[42] * v[37] + v[91] * v[90] + 4.89663865010925e-12 * v[70];
            v[90] = 2.39770700697438e-23 + -1. * v[91];
            v[67] = v[68] * v[40] + v[42] * v[67] + v[90] * v[75];
            v[48] = v[68] * v[65] + v[42] * v[48] + v[90] * v[40];
            v[90] = -1. * v[42] + 4.89663865010925e-12 * v[90];
            v[99] = v[67] * v[36] + v[48] * v[29] + v[90] * v[99];
            v[5] = v[67] * v[33] + v[48] * v[2] + v[90] * v[5];
            v[90] = v[48] + 4.89663865010925e-12 * v[90];
            v[76] = v[99] * v[98] + v[5] * v[76] + v[90] * v[79];
            v[99] = v[99] * v[63] + v[5] * v[62] + v[90] * v[98];
            v[90] = -1. * v[5] + 4.89663865010925e-12 * v[90];
            v[5] = -1. * v[99] + 4.89663865010925e-12 * v[90];
            v[27] = v[76] * v[50] + v[99] * v[27] + v[90] * v[47];
            v[90] = v[76] * v[20] + v[99] * v[25] + v[90] * v[50];
            v[90] = 0.333 + -0.316 * v[91] + 0.0825 * v[68] + -0.0825 * v[67] + 0.384 * v[48] +
                    0.088 * v[76] + 0.212 * v[5] +
                    (0.707106781186865 * v[27] + -0.70710678118623 * v[90]) * v[61] +
                    (0.70710678118623 * v[27] + 0.707106781186865 * v[90]) * v[81] + v[5] * v[60];
            v[93] = (-v[44]) * x[18] + (-v[43]) * x[19] + (-v[93]) * x[20] + v[44] * v[41] + v[43] * v[71] +
                    v[93] * v[90];
            v[43] = v[93] - x[21];
            v[43] = blend(v[43], 0., 0. - v[43]);
            v[93] = v[93] - x[27];
            ...
            v[73] = v[73] * x[14];
            v[44] = v[74] + v[73];
            v[44] = (-v[94]) * x[18] + (-v[95]) * x[19] + (-v[44]) * x[20] + v[94] * v[41] + v[95] * v[71] +
                    v[44] * v[90];
            v[95] = v[44] - x[22];
            v[95] = blend(v[95], 0., 0. - v[95]);
            v[44] = v[44] - x[28];
            v[44] = blend(v[44], 0., v[44] - 0.);
            v[44] = v[95] + v[44];
            v[96] = v[72] + v[96];
            v[73] = v[74] - v[73];
            v[43] = 1. - (v[43] + v[45]);
            v[43] = (-v[96]) * x[18] + (-v[73]) * x[19] + (-v[43]) * x[20] + v[96] * v[41] + v[73] * v[71] +
                    v[43] * v[90];
            v[73] = v[43] - x[23];
            v[73] = blend(v[73], 0., 0. - v[73]);
            v[43] = v[43] - x[29];
            v[43] = blend(v[43], 0., v[43] - 0.);
            v[43] = v[73] + v[43];
            v[73] = 0. - x[24];
            v[73] = blend(v[73], 0., 0. - v[73]);
            v[96] = 0. - x[30];
            v[96] = blend(v[96], 0., v[96] - 0.);
            v[96] = v[73] + v[96];
            v[73] = 0. - x[25];
            v[73] = blend(v[73], 0., 0. - v[73]);
            v[90] = 0. - x[31];
            v[90] = blend(v[90], 0., v[90] - 0.);
            v[90] = v[73] + v[90];
            v[73] = 0. - x[26];
            v[73] = blend(v[73], 0., 0. - v[73]);
            v[71] = 0. - x[32];
            v[71] = blend(v[71], 0., v[71] - 0.);
            v[71] = v[73] + v[71];
            y[33] =
                v[93] * v[93] + v[44] * v[44] + v[43] * v[43] + v[96] * v[96] + v[90] * v[90] + v[71] * v[71];
            // dependent variables without operations
            y[6] = 0.;
            y[7] = 0.;
            y[8] = 0.;
