...
static inline auto tsr_function_ori_blend(const std::array<float, 33> &x, std::array<float, 48> &y) noexcept {
   ...
   v[81] = v[50] + v[67] + v[80];
   v[82] = (v[81] - 1.) / 2.;
   v[83] = blend(acos(v[82]), 0., 3. - v[81]);
   v[83] = blend(v[83], 3.14159265358979, v[81] - -1.);
   v[84] = v[83] * v[83];
   v[85] = 1. / v[84];
   v[86] = sin(v[83]);
   v[87] = 2. * v[83];
   ...
   v[90] = v[87] * v[89];
   v[91] = v[86] / v[90];
   v[92] = blend(v[85] - v[91], 0.0833333333333333 + v[84] / 720., v[83] - 0.0001220703125);
   v[93] = v[75] * v[31] + v[76] * v[36] + v[77] * v[35];
   v[94] = v[93] * v[39] + v[78] * v[44] + v[79] * v[43];
   v[95] = v[93] * v[47] + v[78] * v[48] + v[79] * v[39];
   v[96] = 0.70710678118623 * v[94] + 0.707106781186865 * v[95];
   v[97] = -1. * v[63] + 4.89663865010925e-12 * v[64];
   v[98] = blend(-1., 1., v[97] - v[96]);
   v[99] = (-(v[81] - 1.)) / 2.;
   v[50] = v[50] + v[99];
   v[100] = 1. + v[99];
   v[101] = (v[83] * v[83]) / v[100];
   v[102] = v[50] * v[101];
   v[103] = sqrt(v[102]);
   v[104] = blend(0., v[103], 0. - v[102]);
   v[105] = sin(v[83]);
   v[106] = v[83] / v[105];
   v[107] = blend(1., v[106], 0.0001220703125 - v[83]);
   v[107] = v[107] / 2.;
   v[96] = v[96] - v[97];
   v[104] = blend(v[98] * v[104], v[107] * v[96], v[83] - 3.13159265358979);
   v[108] = -1. * v[42] + 4.89663865010925e-12 * v[45];
   v[109] = -0.316 * v[10] + 0.0825 * v[13] + -0.0825 * v[21] + 0.384 * v[25] + 0.088 * v[38] + 0.212 * v[108];
   v[95] = 0.707106781186865 * v[94] + -0.70710678118623 * v[95];
   v[94] = blend(-1., 1., v[95] - v[108]);
   v[67] = v[67] + v[99];
   v[110] = v[67] * v[101];
   v[111] = sqrt(v[110]);
   v[112] = blend(0., v[111], 0. - v[110]);
   v[95] = v[108] - v[95];
   v[112] = blend(v[94] * v[112], v[107] * v[95], v[83] - 3.13159265358979);
   v[97] = -0.316 * v[52] + 0.0825 * v[53] + -0.0825 * v[56] + 0.384 * v[57] + 0.088 * v[62] + 0.212 * v[97];
   v[66] = 0.707106781186865 * v[65] + -0.70710678118623 * v[66];
   v[49] = 0.70710678118623 * v[46] + 0.707106781186865 * v[49];
   v[46] = blend(-1., 1., v[49] - v[66]);
   v[99] = v[80] + v[99];
   v[65] = v[99] * v[101];
   v[108] = sqrt(v[65]);
   v[113] = blend(0., v[108], 0. - v[65]);
   v[49] = v[66] - v[49];
   v[113] = blend(v[46] * v[113], v[107] * v[49], v[83] - 3.13159265358979);
   v[80] = 0.333 + -0.316 * v[68] + 0.0825 * v[69] + -0.0825 * v[72] + 0.384 * v[73] + 0.088 * v[93] + 0.212 * v[80];
   v[66] = v[104] * v[109] + v[112] * v[97] + v[113] * v[80];
   v[114] = v[92] * v[66];
   v[115] = v[104] * v[92];
   v[116] = v[114] + v[115] * v[109];
   v[117] = blend(0., v[116], v[83] - 3.13159265358979);
   v[118] = v[117] * v[107];
   v[119] = 0.5 * v[113] + v[115] * v[112];
   v[120] = 0. - v[118] + v[119] * 0.212;
   v[121] = -0.5 * v[80] + v[115] * v[97];
   v[122] = blend(v[121], 0., v[83] - 3.13159265358979);
   v[122] = blend(0., v[122] * v[94], 0. - v[110]);
   v[122] = (v[122] * 1. / v[111]) / 2.;
   v[123] = v[122] * v[101];
   v[124] = 0.5 * v[97] + v[115] * v[80];
   v[125] = blend(v[124], 0., v[83] - 3.13159265358979);
   v[125] = blend(0., v[125] * v[46], 0. - v[65]);
   v[125] = (v[125] * 1. / v[108]) / 2.;
   v[126] = v[125] * v[101];
   v[116] = blend(v[116], 0., v[83] - 3.13159265358979);
   v[116] = blend(0., v[116] * v[98], 0. - v[102]);
   v[116] = (v[116] * 1. / v[103]) / 2.;
   v[127] = v[116] * v[101];
   v[116] = (v[125] * v[99] + v[122] * v[67] + v[116] * v[50]) * 1. / v[100];
   v[125] = v[104] * v[66];
   v[122] = blend(v[125], 0., v[83] - 0.0001220703125);
   v[128] = (0. - v[122]) * 1. / v[90];
   v[129] = 0. - v[128] * v[91];
   v[130] = blend(v[109], 0., v[83] - 0.0001220703125);
   v[88] = 2. * (1. - v[88]);
   v[130] = v[130] * 1. / v[88];
   v[131] = (v[83] * v[86]) / v[88];
   v[132] = sin(v[83]);
   v[133] = cos(v[83]);
   v[125] = blend(0., v[125], v[83] - 0.0001220703125);
   v[134] = blend(0., v[109], v[83] - 0.0001220703125);
   v[135] = (0. - v[134]) * 0.00138888888888889;
   v[135] = v[125] * 0.00138888888888889 - v[122] * 1. / v[84] * v[85] + (0. - v[134]) * 0.0833333333333333 + v[135] * v[84] + v[135] * v[84];
   v[124] = blend(0., v[124], v[83] - 3.13159265358979);
   v[121] = blend(0., v[121], v[83] - 3.13159265358979);
   v[117] = blend(0., (v[124] * v[49] + v[121] * v[95] + v[117] * v[96]) * 0.5, 0.0001220703125 - v[83]);
   v[117] = v[117] * 1. / v[105];
   v[134] = cos(v[83]);
   v[117] = blend(v[129] * v[89] * 2. + v[130] * v[86] - (0. - v[129] * v[87] - (0. - v[130] * v[131]) * 2.) * v[132] + (v[128] + v[130] * v[83]) * v[133] + v[135] * v[83] + v[135] * v[83] + v[117] + (0. - v[117] * v[106]) * v[134] + v[116] * v[83] + v[116] * v[83], 0., v[81] - -1.);
   v[117] = blend(v[117], 0., 3. - v[81]);
   v[82] = sqrt(1. - v[82] * v[82]);
   v[117] = (v[126] + v[123] + v[127] + 0. - v[116] * v[101]) * 0.5 * -1. + (0. - v[117] * 1. / v[82]) * 0.5;
   v[123] = v[123] + v[117];
   v[124] = v[124] * v[107];
   ...
   v[137] = v[119] * 0.0825 + v[129] * v[23] + v[122] * v[14];
   v[119] = v[119] * -0.316 + v[136] * -1. + v[125] * v[16] + v[137] * v[12];
   v[138] = blend(v[131], 1. - v[84] / 12. - (v[84] * v[84]) / 720., v[83] - 0.0001220703125);
   v[139] = v[138] + v[115] * v[104];
   v[121] = v[121] * v[107];
   v[140] = v[121] + v[139] * 0.212;
   v[124] = 0. - v[124];
   ...
   v[121] = v[112] * v[92];
   v[126] = 0.5 * v[80] + v[121] * v[109];
   v[127] = blend(0., v[126], v[83] - 3.13159265358979);
   v[141] = v[127] * v[107];
   v[123] = v[138] + v[121] * v[112];
   v[116] = 0. - v[141] + v[123] * 0.212;
   v[142] = v[114] + v[121] * v[97];
   v[140] = blend(v[142], 0., v[83] - 3.13159265358979);
   v[140] = blend(0., v[140] * v[94], 0. - v[110]);
   v[140] = (v[140] * 1. / v[111]) / 2.;
   v[130] = v[140] * v[101];
   v[120] = -0.5 * v[109] + v[121] * v[80];
   v[144] = blend(v[120], 0., v[83] - 3.13159265358979);
   v[144] = blend(0., v[144] * v[46], 0. - v[65]);
   v[144] = (v[144] * 1. / v[108]) / 2.;
   v[124] = v[144] * v[101];
   v[126] = blend(v[126], 0., v[83] - 3.13159265358979);
   v[126] = blend(0., v[126] * v[98], 0. - v[102]);
   v[126] = (v[126] * 1. / v[103]) / 2.;
   v[128] = v[126] * v[101];
   v[126] = (v[144] * v[99] + v[140] * v[67] + v[126] * v[50]) * 1. / v[100];
   v[144] = v[112] * v[66];
   v[140] = blend(v[144], 0., v[83] - 0.0001220703125);
   v[135] = (0. - v[140]) * 1. / v[90];
   v[146] = 0. - v[135] * v[91];
   v[143] = blend(v[97], 0., v[83] - 0.0001220703125);
   v[143] = v[143] * 1. / v[88];
   v[144] = blend(0., v[144], v[83] - 0.0001220703125);
   v[122] = blend(0., v[97], v[83] - 0.0001220703125);
   v[129] = (0. - v[122]) * 0.00138888888888889;
   v[129] = v[144] * 0.00138888888888889 - v[140] * 1. / v[84] * v[85] + (0. - v[122]) * 0.0833333333333333 + v[129] * v[84] + v[129] * v[84];
   v[120] = blend(0., v[120], v[83] - 3.13159265358979);
   v[142] = blend(0., v[142], v[83] - 3.13159265358979);
   v[127] = blend(0., (v[120] * v[49] + v[142] * v[95] + v[127] * v[96]) * 0.5, 0.0001220703125 - v[83]);
   v[127] = v[127] * 1. / v[105];
   v[127] = blend(v[146] * v[89] * 2. + v[143] * v[86] - (0. - v[146] * v[87] - (0. - v[143] * v[131]) * 2.) * v[132] + (v[135] + v[143] * v[83]) * v[133] + v[129] * v[83] + v[129] * v[83] + v[127] + (0. - v[127] * v[106]) * v[134] + v[126] * v[83] + v[126] * v[83], 0., v[81] - -1.);
   v[127] = blend(v[127], 0., 3. - v[81]);
   v[127] = (v[124] + v[130] + v[128] + 0. - v[126] * v[101]) * 0.5 * -1. + (0. - v[127] * 1. / v[82]) * 0.5;
   v[130] = v[130] + v[127];
   v[120] = v[120] * v[107];
   v[126] = v[130] * 0.707106781186865 + v[120] * -0.70710678118623;
   ...
   v[92] = v[113] * v[92];
   v[142] = -0.5 * v[97] + v[92] * v[109];
   v[124] = blend(0., v[142], v[83] - 3.13159265358979);
   v[128] = v[124] * v[107];
   v[125] = -0.5 * v[104] + v[92] * v[112];
   v[130] = 0. - v[128] + v[125] * 0.212;
   v[97] = 0.5 * v[109] + v[92] * v[97];
   v[109] = blend(v[97], 0., v[83] - 3.13159265358979);
   v[109] = blend(0., v[109] * v[94], 0. - v[110]);
   v[109] = (v[109] * 1. / v[111]) / 2.;
   v[126] = v[109] * v[101];
   v[114] = v[114] + v[92] * v[80];
   v[161] = blend(v[114], 0., v[83] - 3.13159265358979);
   v[161] = blend(0., v[161] * v[46], 0. - v[65]);
   v[161] = (v[161] * 1. / v[108]) / 2.;
   v[127] = v[161] * v[101];
   v[142] = blend(v[142], 0., v[83] - 3.13159265358979);
   v[142] = blend(0., v[142] * v[98], 0. - v[102]);
   v[142] = (v[142] * 1. / v[103]) / 2.;
   v[150] = v[142] * v[101];
   v[142] = (v[161] * v[99] + v[109] * v[67] + v[142] * v[50]) * 1. / v[100];
   v[66] = v[113] * v[66];
   v[161] = blend(v[66], 0., v[83] - 0.0001220703125);
   v[90] = (0. - v[161]) * 1. / v[90];
   v[91] = 0. - v[90] * v[91];
   v[109] = blend(v[80], 0., v[83] - 0.0001220703125);
   v[109] = v[109] * 1. / v[88];
   v[66] = blend(0., v[66], v[83] - 0.0001220703125);
   v[80] = blend(0., v[80], v[83] - 0.0001220703125);
   v[88] = (0. - v[80]) * 0.00138888888888889;
   v[88] = v[66] * 0.00138888888888889 - v[161] * 1. / v[84] * v[85] + (0. - v[80]) * 0.0833333333333333 + v[88] * v[84] + v[88] * v[84];
   v[114] = blend(0., v[114], v[83] - 3.13159265358979);
   v[97] = blend(0., v[97], v[83] - 3.13159265358979);
   v[124] = blend(0., (v[114] * v[49] + v[97] * v[95] + v[124] * v[96]) * 0.5, 0.0001220703125 - v[83]);
   v[124] = v[124] * 1. / v[105];
   v[124] = blend(v[91] * v[89] * 2. + v[109] * v[86] - (0. - v[91] * v[87] - (0. - v[109] * v[131]) * 2.) * v[132] + (v[90] + v[109] * v[83]) * v[133] + v[88] * v[83] + v[88] * v[83] + v[124] + (0. - v[124] * v[106]) * v[134] + v[142] * v[83] + v[142] * v[83], 0., v[81] - -1.);
   v[124] = blend(v[124], 0., 3. - v[81]);
   v[124] = (v[127] + v[126] + v[150] + 0. - v[142] * v[101]) * 0.5 * -1. + (0. - v[124] * 1. / v[82]) * 0.5;
   v[126] = v[126] + v[124];
   v[114] = v[114] * v[107];
   v[142] = v[126] * 0.707106781186865 + v[114] * -0.70710678118623;
   ...
   y[19] = 0. - (v[124] * v[77] + v[130] * v[61] + v[104] * v[37] + v[138] * v[75] + v[109] * v[59] + v[86] * v[30] + (v[124] * v[76] + v[130] * v[60] + v[104] * v[34]) * 4.89663865010925e-12) * v[153] + (v[138] * v[77] + v[109] * v[61] + v[86] * v[37] + (v[138] * v[76] + v[109] * v[60] + v[86] * v[34]) * 4.89663865010925e-12 + (v[124] * v[75] + v[130] * v[59] + v[104] * v[30]) * -1.) * v[118];
   y[20] = 0. - (v[127] * v[79] + v[142] * v[64] + v[87] * v[45] + v[97] * v[93] + v[126] * v[62] + v[150] * v[38] + (v[127] * v[78] + v[142] * v[63] + v[87] * v[42]) * 4.89663865010925e-12) * v[147] + (v[97] * v[79] + v[126] * v[64] + v[150] * v[45] + (v[97] * v[78] + v[126] * v[63] + v[150] * v[42]) * 4.89663865010925e-12 + (v[127] * v[93] + v[142] * v[62] + v[87] * v[38]) * -1.) * v[117];
   v[97] = blend(0., 1., v[83] - 3.13159265358979);
   v[127] = v[97] * v[107];
   v[150] = 0. - v[127];
   v[87] = blend(1., 0., v[83] - 3.13159265358979);
   v[87] = blend(0., v[87] * v[98], 0. - v[102]);
   v[87] = (v[87] * 1. / v[103]) / 2.;
   v[103] = v[87] * v[101];
   v[87] = v[87] * v[50] * 1. / v[100];
   v[97] = blend(0., v[97] * v[96] * 0.5, 0.0001220703125 - v[83]);
   v[97] = v[97] * 1. / v[105];
   v[97] = blend(v[97] + (0. - v[97] * v[106]) * v[134] + v[87] * v[83] + v[87] * v[83], 0., v[81] - -1.);
   v[97] = blend(v[97], 0., 3. - v[81]);
   v[97] = (v[103] + 0. - v[87] * v[101]) * 0.5 * -1. + (0. - v[97] * 1. / v[82]) * 0.5;
   v[87] = v[97] * 0.707106781186865;
   v[96] = v[97] * 0.70710678118623;
   v[50] = v[150] * 4.89663865010925e-12 + v[87] * v[39] + v[96] * v[43];
   ...
   y[26] = 0. - (v[97] * v[77] + v[150] * v[61] + v[84] * v[37] + v[91] * v[75] + v[102] * v[59] + v[128] * v[30] + (v[97] * v[76] + v[150] * v[60] + v[84] * v[34]) * 4.89663865010925e-12) * v[153] + (v[91] * v[77] + v[102] * v[61] + v[128] * v[37] + (v[91] * v[76] + v[102] * v[60] + v[128] * v[34]) * 4.89663865010925e-12 + (v[97] * v[75] + v[150] * v[59] + v[84] * v[30]) * -1.) * v[118];
   y[27] = 0. - (v[165] * v[79] + v[87] * v[64] + v[109] * v[45] + v[127] * v[93] + v[96] * v[62] + v[103] * v[38] + (v[165] * v[78] + v[87] * v[63] + v[109] * v[42]) * 4.89663865010925e-12) * v[147] + (v[127] * v[79] + v[96] * v[64] + v[103] * v[45] + (v[127] * v[78] + v[96] * v[63] + v[103] * v[42]) * 4.89663865010925e-12 + (v[165] * v[93] + v[87] * v[62] + v[109] * v[38]) * -1.) * v[117];
   v[127] = blend(1., 0., v[83] - 3.13159265358979);
   v[127] = blend(0., v[127] * v[94], 0. - v[110]);
   v[127] = (v[127] * 1. / v[111]) / 2.;
   v[111] = v[127] * v[101];
   v[127] = v[127] * v[67] * 1. / v[100];
   v[67] = blend(0., 1., v[83] - 3.13159265358979);
   v[95] = blend(0., v[67] * v[95] * 0.5, 0.0001220703125 - v[83]);
   v[95] = v[95] * 1. / v[105];
   v[95] = blend(v[95] + (0. - v[95] * v[106]) * v[134] + v[127] * v[83] + v[127] * v[83], 0., v[81] - -1.);
   v[95] = blend(v[95], 0., 3. - v[81]);
   v[95] = (v[111] + 0. - v[127] * v[101]) * 0.5 * -1. + (0. - v[95] * 1. / v[82]) * 0.5;
   v[111] = v[111] + v[95];
   v[127] = v[111] * 0.707106781186865;
   v[111] = v[111] * 0.70710678118623;
   ...
   y[33] = 0. - (v[95] * v[77] + v[94] * v[61] + v[141] * v[37] + v[98] * v[75] + v[165] * v[59] + v[124] * v[30] + (v[95] * v[76] + v[94] * v[60] + v[141] * v[34]) * 4.89663865010925e-12) * v[153] + (v[98] * v[77] + v[165] * v[61] + v[124] * v[37] + (v[98] * v[76] + v[165] * v[60] + v[124] * v[34]) * 4.89663865010925e-12 + (v[95] * v[75] + v[94] * v[59] + v[141] * v[30]) * -1.) * v[118];
   y[34] = 0. - (v[161] * v[79] + v[127] * v[64] + v[84] * v[45] + v[67] * v[93] + v[111] * v[62] + v[102] * v[38] + (v[161] * v[78] + v[127] * v[63] + v[84] * v[42]) * 4.89663865010925e-12) * v[147] + (v[67] * v[79] + v[111] * v[64] + v[102] * v[45] + (v[67] * v[78] + v[111] * v[63] + v[102] * v[42]) * 4.89663865010925e-12 + (v[161] * v[93] + v[127] * v[62] + v[84] * v[38]) * -1.) * v[117];
   v[67] = blend(1., 0., v[83] - 3.13159265358979);
   v[67] = blend(0., v[67] * v[46], 0. - v[65]);
   v[67] = (v[67] * 1. / v[108]) / 2.;
   v[108] = v[67] * v[101];
   v[67] = v[67] * v[99] * 1. / v[100];
   v[99] = blend(0., 1., v[83] - 3.13159265358979);
   v[49] = blend(0., v[99] * v[49] * 0.5, 0.0001220703125 - v[83]);
   v[49] = v[49] * 1. / v[105];
   v[49] = blend(v[49] + (0. - v[49] * v[106]) * v[134] + v[67] * v[83] + v[67] * v[83], 0., v[81] - -1.);
   v[49] = blend(v[49], 0., 3. - v[81]);
   v[49] = (v[108] + 0. - v[67] * v[101]) * 0.5 * -1. + (0. - v[49] * 1. / v[82]) * 0.5;
   v[99] = v[99] * v[107];
   v[107] = v[49] * 0.707106781186865 + v[99] * -0.70710678118623;
   v[67] = v[49] * 0.70710678118623 + v[99] * 0.707106781186865;
   ...
   v[134] = v[99] * v[105] + v[136] * v[67] + v[56] * v[161];
   v[43] = v[25] + v[82] + v[134];
   v[13] = blend(acos((v[43] - 1.) / 2.), 0., 3. - v[43]);
   v[13] = blend(v[13], 3.14159265358979, v[43] - -1.);
   v[108] = v[13] * v[13];
   v[36] = sin(v[13]);
   v[37] = cos(v[13]);
   v[45] = blend((v[13] * v[36]) / (2. * (1. - v[37])), 1. - v[108] / 12. - (v[108] * v[108]) / 720., v[13] - 0.0001220703125);
   v[35] = (- v[157]) * x[11] + (- v[71]) * x[12] + (- v[35]) * x[13];
   v[155] = (- v[70]) * x[11] + (- v[156]) * x[12] + (- v[155]) * x[13];
   v[54] = (- v[69]) * x[11] + (- v[58]) * x[12] + (- v[54]) * x[13];
   v[62] = -0.316 * v[81] + 0.0825 * v[153] + -0.0825 * v[59] + 0.384 * v[40] + 0.088 * v[72] + 0.212 * v[62] + v[44] * v[35] + v[31] * v[155] + v[62] * v[54];
   ...
   v[35] = v[117] * v[105] + v[20] * v[67] + v[39] * v[161];
   v[75] = v[99] * v[55] + v[136] * v[42] + v[56] * v[38];
   v[26] = blend(-1., 1., v[75] - v[35]);
   v[43] = (-(v[43] - 1.)) / 2.;
   v[21] = (v[13] * v[13]) / (1. + v[43]);
   v[82] = (v[82] + v[43]) * v[21];
   v[82] = blend(0., sqrt(v[82]), 0. - v[82]);
   v[73] = blend(1., v[13] / sin(v[13]), 0.0001220703125 - v[13]);
   v[73] = v[73] / 2.;
   y[46] = blend(v[26] * v[82], v[73] * (v[35] - v[75]), v[13] - 3.13159265358979);
   v[82] = (- v[99]) * x[18] + (- v[136]) * x[19] + (- v[56]) * x[20] + v[99] * v[62] + v[136] * v[147] + v[56] * v[54];
   v[38] = v[53] * v[55] + v[107] * v[42] + v[106] * v[38];
   v[39] = v[117] * v[28] + v[20] * v[57] + v[39] * v[74];
   v[20] = blend(-1., 1., v[39] - v[38]);
   v[134] = (v[134] + v[43]) * v[21];
   v[134] = blend(0., sqrt(v[134]), 0. - v[134]);
   y[47] = blend(v[20] * v[134], v[73] * (v[38] - v[39]), v[13] - 3.13159265358979);
   v[54] = (- v[53]) * x[18] + (- v[107]) * x[19] + (- v[106]) * x[20] + v[53] * v[62] + v[107] * v[147] + v[106] * v[54];
   v[37] = blend(1. / v[108] - v[36] / (2. * v[13] * (1. - v[37])), 0.0833333333333333 + v[108] / 720., v[13] - 0.0001220703125);
   v[56] = v[99] * v[28] + v[136] * v[57] + v[56] * v[74];
   v[161] = v[53] * v[105] + v[107] * v[67] + v[106] * v[161];
   v[67] = blend(-1., 1., v[161] - v[56]);
   v[21] = (v[25] + v[43]) * v[21];
   v[21] = blend(0., sqrt(v[21]), 0. - v[21]);
   y[45] = blend(v[67] * v[21], v[73] * (v[56] - v[161]), v[13] - 3.13159265358979);
   v[37] = v[37] * (y[45] * v[155] + y[46] * v[54] + y[47] * v[82]);
   y[42] = v[45] * v[155] - 0.5 * (y[46] * v[82] - y[47] * v[54]) + v[37] * y[45];
   y[43] = v[45] * v[54] - 0.5 * (y[47] * v[155] - y[45] * v[82]) + v[37] * y[46];
   y[44] = v[45] * v[82] - 0.5 * (y[45] * v[54] - y[46] * v[155]) + v[37] * y[47];
