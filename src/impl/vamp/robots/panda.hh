...
namespace vamp::robots
{
    struct Panda
    {
        ...
        static constexpr std::size_t se3_dim = 16;
        static constexpr std::size_t kin_jac_dim = dimension * 6;  // 6 is for xyzrpy
        ...
        using SE3 = FloatVector<se3_dim>;
        using SE3Array = std::array<FloatT, se3_dim>;
        template <std::size_t rake>
        using SE3Block = FloatVector<rake, se3_dim>;

        using KinJac = FloatVector<kin_jac_dim>;
        using KinJacArray = std::array<FloatT, kin_jac_dim>;
        template <std::size_t rake>
        using KinJacBlock = FloatVector<rake, kin_jac_dim>;
        ...
        jacobian(const std::array<float, 7> &x) noexcept -> Eigen::Matrix<float, 6, Eigen::Dynamic>
        {
            ...
            v[6] = sin(x[6]);
            v[7] = -v[6];
            v[8] = 0.707106781186865 * v[5] + -0.70710678118623 * v[7];
            v[9] = sin(x[5]);
            v[10] = -v[9];
            v[11] = 4.89663865010925e-12 * v[6];
            v[12] = 4.89663865010925e-12 * v[5];
            v[13] = 0.707106781186865 * v[11] + -0.70710678118623 * v[12];
            v[14] = v[4] * v[8] + v[10] * v[13];
            v[15] = sin(x[4]);
            v[16] = -v[15];
            v[17] = 4.89663865010925e-12 * v[9];
            v[18] = 4.89663865010925e-12 * v[4];
            y[33] = 0.707106781186865 * v[6] + -0.70710678118623 * v[5];
            v[19] = v[17] * v[8] + v[18] * v[13] + -1. * y[33];
            v[20] = v[3] * v[14] + v[16] * v[19];
            v[21] = sin(x[3]);
            v[22] = -v[21];
            v[23] = 4.89663865010925e-12 * v[15];
            v[24] = 4.89663865010925e-12 * v[3];
            y[27] = v[9] * v[8] + v[4] * v[13] + 4.89663865010925e-12 * y[33];
            v[25] = v[23] * v[14] + v[24] * v[19] + y[27];
            v[26] = v[2] * v[20] + v[22] * v[25];
            v[27] = sin(x[2]);
            v[28] = -v[27];
            v[29] = 4.89663865010925e-12 * v[21];
            v[30] = 4.89663865010925e-12 * v[2];
            v[15] = -1. * v[15];
            v[31] = -1. * v[3];
            y[21] = v[15] * v[14] + v[31] * v[19] + 4.89663865010925e-12 * y[27];
            v[32] = v[29] * v[20] + v[30] * v[25] + -1. * y[21];
            v[33] = v[1] * v[26] + v[28] * v[32];
            v[34] = sin(x[1]);
            v[35] = -v[34];
            v[36] = 4.89663865010925e-12 * v[27];
            v[37] = 4.89663865010925e-12 * v[1];
            y[15] = v[21] * v[20] + v[2] * v[25] + 4.89663865010925e-12 * y[21];
            v[38] = v[36] * v[26] + v[37] * v[32] + -1. * y[15];
            v[39] = 4.89663865010925e-12 * v[34];
            v[40] = 0.088 * v[4] + -0.212 * v[10];
            v[41] = 0.088 * v[17] + -1.03808739382316e-12 + -0.212 * v[18];
            v[42] = -0.0825 + v[3] * v[40] + v[16] * v[41];
            v[43] = 0.088 * v[9] + 5.08313885478568e-24 + -0.212 * v[4];
            v[44] = 0.384 + v[23] * v[40] + v[24] * v[41] + v[43];
            v[45] = 0.0825 + v[2] * v[42] + v[22] * v[44];
            v[43] = v[15] * v[40] + v[31] * v[41] + 4.89663865010925e-12 * v[43];
            v[46] = v[29] * v[42] + v[30] * v[44] + -1. * v[43];
            v[47] = v[1] * v[45] + v[28] * v[46];
            v[48] = 4.89663865010925e-12 * v[0];
            v[43] = v[21] * v[42] + v[2] * v[44] + 4.89663865010925e-12 * v[43];
            v[49] = -0.316 + v[36] * v[45] + v[37] * v[46] + -1. * v[43];
            v[43] = -(
                v[39] * v[47] + v[48] * v[49] + v[27] * v[45] + v[1] * v[46] + 4.89663865010925e-12 * v[43]);
            y[9] = v[27] * v[26] + v[1] * v[32] + 4.89663865010925e-12 * y[15];
            v[50] = v[0] * v[47] + v[35] * v[49];
            y[0] = (v[0] * v[33] + v[35] * v[38]) * v[43] + (v[39] * v[33] + v[48] * v[38] + y[9]) * v[50];
            v[7] = 0.70710678118623 * v[5] + 0.707106781186865 * v[7];
            v[12] = 0.70710678118623 * v[11] + 0.707106781186865 * v[12];
            v[11] = v[4] * v[7] + v[10] * v[12];
            y[34] = 0.70710678118623 * v[6] + 0.707106781186865 * v[5];
            v[17] = v[17] * v[7] + v[18] * v[12] + -1. * y[34];
            v[6] = v[3] * v[11] + v[16] * v[17];
            y[28] = v[9] * v[7] + v[4] * v[12] + 4.89663865010925e-12 * y[34];
            v[9] = v[23] * v[11] + v[24] * v[17] + y[28];
            v[5] = v[2] * v[6] + v[22] * v[9];
            y[22] = v[15] * v[11] + v[31] * v[17] + 4.89663865010925e-12 * y[28];
            v[51] = v[29] * v[6] + v[30] * v[9] + -1. * y[22];
            v[52] = v[1] * v[5] + v[28] * v[51];
            y[16] = v[21] * v[6] + v[2] * v[9] + 4.89663865010925e-12 * y[22];
            v[53] = v[36] * v[5] + v[37] * v[51] + -1. * y[16];
            y[10] = v[27] * v[5] + v[1] * v[51] + 4.89663865010925e-12 * y[16];
            y[1] = (v[0] * v[52] + v[35] * v[53]) * v[43] + (v[39] * v[52] + v[48] * v[53] + y[10]) * v[50];
            v[10] = -1. * v[10];
            v[18] = -4.89663865010925e-12 + -1. * v[18];
            v[16] = v[3] * v[10] + v[16] * v[18];
            y[29] = 2.39770700697438e-23 + -1. * v[4];
            v[24] = v[23] * v[10] + v[24] * v[18] + y[29];
            v[22] = v[2] * v[16] + v[22] * v[24];
            y[23] = v[15] * v[10] + v[31] * v[18] + 4.89663865010925e-12 * y[29];
            v[30] = v[29] * v[16] + v[30] * v[24] + -1. * y[23];
            v[28] = v[1] * v[22] + v[28] * v[30];
            y[17] = v[21] * v[16] + v[2] * v[24] + 4.89663865010925e-12 * y[23];
            v[37] = v[36] * v[22] + v[37] * v[30] + -1. * y[17];
            y[11] = v[27] * v[22] + v[1] * v[30] + 4.89663865010925e-12 * y[17];
            y[2] = (v[0] * v[28] + v[35] * v[37]) * v[43] + (v[39] * v[28] + v[48] * v[37] + y[11]) * v[50];
            v[34] = -1. * v[34];
            v[0] = -1. * v[0];
            y[3] = v[34] * v[33] + v[0] * v[38] + 4.89663865010925e-12 * y[9];
            y[4] = v[34] * v[52] + v[0] * v[53] + 4.89663865010925e-12 * y[10];
            y[5] = v[34] * v[28] + v[0] * v[37] + 4.89663865010925e-12 * y[11];
            v[49] = -v[49];
            y[6] = v[33] * v[49] + v[38] * v[47];
            y[7] = v[52] * v[49] + v[53] * v[47];
            y[8] = v[28] * v[49] + v[37] * v[47];
            v[46] = -v[46];
            y[12] = v[26] * v[46] + v[32] * v[45];
            y[13] = v[5] * v[46] + v[51] * v[45];
            y[14] = v[22] * v[46] + v[30] * v[45];
            v[44] = -v[44];
            y[18] = v[20] * v[44] + v[25] * v[42];
            y[19] = v[6] * v[44] + v[9] * v[42];
            y[20] = v[16] * v[44] + v[24] * v[42];
            v[41] = -v[41];
            y[24] = v[14] * v[41] + v[19] * v[40];
            y[25] = v[11] * v[41] + v[17] * v[40];
            y[26] = v[10] * v[41] + v[18] * v[40];
            y[30] = 0.212 * v[8] + 0.088 * v[13];
            y[31] = 0.212 * v[7] + 0.088 * v[12];
            // dependent variables without operations
            y[32] = -0.088;
        ...
        inline static auto jacobian_solve(
            const std::array<float, 42> &J,
            const std::array<float, 16> &T,
            std::array<float, 7> &grad,
            std::array<float, 6> &error) noexcept -> double
        {
            std::array<float, 58> x;
            std::copy(J.begin(), J.end(), x.begin());
            std::copy(T.begin(), T.end(), x.begin() + 42);
            ...
            if (v[0] < -1.)
            {
                v[1] = 3.14159265358979;
            }
            else
            {
                v[1] = v[1];
            }
            v[2] = sin(v[1]) / (1. - cos(v[1]));
            if (v[1] < 0.0001220703125)
            {
                v[3] = 0.0833333333333333 + (v[1] * v[1]) / 720.;
            }
            else
            {
                v[3] = 1. / (v[1] * v[1]) - v[2] / (2. * v[1]);
            }
            if (x[51] > x[48])
            {
                v[4] = 1.;
            ...
            v[10] = v[4] * v[11] - 0.5 * v[5];
            v[7] = -v[10];
            v[4] = v[4] * v[5] + 0.5 * v[11];
            v[0] = -v[4];
            v[12] = 1. / v[1];
            v[13] = v[12] * v[12];
            v[14] = sin(v[1]);
            ...
            if (v[1] < 0.0001220703125)
            {
                v[16] = 0.00277777777777778;
            }
            else
            {
                v[16] = -2. * v[13] * v[13] + (1. + v[14] * v[12]) * v[13] * v[15];
            }
            v[17] = (-x[42]) * x[54] + (-x[43]) * x[55] + (-x[44]) * x[56];
            v[18] = (-x[46]) * x[54] + (-x[47]) * x[55] + (-x[48]) * x[56];
            v[19] = (-x[50]) * x[54] + (-x[51]) * x[55] + (-x[52]) * x[56];
            v[20] = v[6] * v[17] + v[11] * v[18] + v[5] * v[19];
            v[21] = v[16] * v[20];
            v[22] = v[1] * v[1];
            if (v[1] < 0.0001220703125)
            {
                v[15] = 0.0833333333333333 + v[22] / 720.;
            }
            else
            {
                v[15] = v[13] - v[14] * v[12] * v[15];
            }
            v[22] = v[22] * v[16] + 2. * v[15];
            v[16] = v[21] * v[6] - v[22] * v[17];
            v[14] = v[15] * v[6];
            v[20] = v[20] * v[15];
            v[13] = v[16] * v[6] + v[14] * v[17] + v[20];
            v[12] = v[16] * v[11] + v[14] * v[18] - 0.5 * v[19];
            v[23] = v[3] * v[11];
            v[24] = v[23] * v[6] + 0.5 * v[5];
            v[14] = v[16] * v[5] + v[14] * v[19] + 0.5 * v[18];
            v[3] = v[3] * v[5];
            v[16] = v[3] * v[6] - 0.5 * v[11];
            v[25] = -(v[13] * v[8] + v[12] * v[24] + v[14] * v[16]);
            v[26] = v[23] * v[11];
            if (v[1] < 0.0001220703125)
            {
                v[26] = v[26] + 0.5 * (2. - (v[1] * v[1]) / 6.);
            }
            else
            {
                v[26] = v[26] + 0.5 * v[1] * v[2];
            }
            v[27] = v[3] * v[11] + 0.5 * v[6];
            v[28] = -(v[13] * v[10] + v[12] * v[26] + v[14] * v[27]);
            v[23] = v[23] * v[5] - 0.5 * v[6];
            v[3] = v[3] * v[5];
            if (v[1] < 0.0001220703125)
            {
                v[3] = v[3] + 0.5 * (2. - (v[1] * v[1]) / 6.);
            }
            else
            {
                v[3] = v[3] + 0.5 * v[1] * v[2];
            }
            v[14] = -(v[13] * v[4] + v[12] * v[23] + v[14] * v[3]);
            v[12] = x[42] + x[47] + x[52];
            if (v[12] > 3.)
            {
                v[13] = 0.;
            ...
            {
                v[30] = 1. - v[2] / 12. - (v[2] * v[2]) / 720.;
            }
            else
            {
                v[30] = (v[13] * v[1]) / (2. * (1. - v[29]));
            }
            if (x[50] > x[44])
            {
                v[31] = 1.;
            ...
            if (v[13] < 0.0001220703125)
            {
                v[29] = 0.0833333333333333 + v[2] / 720.;
            }
            else
            {
                v[29] = 1. / v[2] - v[1] / (2. * v[13] * (1. - v[29]));
            }
            if (x[48] > x[51])
            {
                v[1] = 1.;
            ...
            v[29] = v[29] * (y[10] * x[54] + y[11] * x[55] + y[12] * x[56]);
            y[7] = v[30] * x[54] - 0.5 * (y[11] * x[56] - y[12] * x[55]) + v[29] * y[10];
            v[32] = -v[24];
            v[1] = -v[26];
            v[34] = -v[23];
            v[13] = v[21] * v[11] - v[22] * v[18];
            v[12] = v[15] * v[11];
            v[2] = v[13] * v[6] + v[12] * v[17] + 0.5 * v[19];
            v[31] = v[13] * v[11] + v[12] * v[18] + v[20];
            v[12] = v[13] * v[5] + v[12] * v[19] - 0.5 * v[17];
            v[13] = -(v[2] * v[8] + v[31] * v[24] + v[12] * v[16]);
            v[33] = -(v[2] * v[10] + v[31] * v[26] + v[12] * v[27]);
            v[12] = -(v[2] * v[4] + v[31] * v[23] + v[12] * v[3]);
            y[8] = v[30] * x[55] - 0.5 * (y[12] * x[54] - y[10] * x[56]) + v[29] * y[11];
            v[31] = -v[16];
            v[2] = -v[27];
            v[35] = -v[3];
            v[22] = v[21] * v[5] - v[22] * v[19];
            v[15] = v[15] * v[5];
            v[6] = v[22] * v[6] + v[15] * v[17] - 0.5 * v[18];
            v[18] = v[22] * v[11] + v[15] * v[18] + 0.5 * v[17];
            v[15] = v[22] * v[5] + v[15] * v[19] + v[20];
            v[22] = -(v[6] * v[8] + v[18] * v[24] + v[15] * v[16]);
            v[20] = -(v[6] * v[10] + v[18] * v[26] + v[15] * v[27]);
            v[15] = -(v[6] * v[4] + v[18] * v[23] + v[15] * v[3]);
            y[9] = v[30] * x[56] - 0.5 * (y[10] * x[55] - y[11] * x[54]) + v[29] * y[12];
            v[8] = -v[8];
            v[10] = -v[10];
            v[4] = -v[4];
            v[24] = -v[24];
            ...
            v[3] = -v[3];
            y[0] =
                (-(v[9] * x[0] + v[7] * x[1] + v[0] * x[2] + v[25] * x[3] + v[28] * x[4] + v[14] * x[5])) *
                    y[7] +
                (-(v[32] * x[0] + v[1] * x[1] + v[34] * x[2] + v[13] * x[3] + v[33] * x[4] + v[12] * x[5])) *
                    y[8] +
                (-(v[31] * x[0] + v[2] * x[1] + v[35] * x[2] + v[22] * x[3] + v[20] * x[4] + v[15] * x[5])) *
                    y[9] +
                (-(v[8] * x[3] + v[10] * x[4] + v[4] * x[5])) * y[10] +
                (-(v[24] * x[3] + v[26] * x[4] + v[23] * x[5])) * y[11] +
                (-(v[16] * x[3] + v[27] * x[4] + v[3] * x[5])) * y[12];
            y[1] =
                (-(v[9] * x[6] + v[7] * x[7] + v[0] * x[8] + v[25] * x[9] + v[28] * x[10] + v[14] * x[11])) *
                    y[7] +
                (-(v[32] * x[6] + v[1] * x[7] + v[34] * x[8] + v[13] * x[9] + v[33] * x[10] +
                   v[12] * x[11])) *
                    y[8] +
                (-(v[31] * x[6] + v[2] * x[7] + v[35] * x[8] + v[22] * x[9] + v[20] * x[10] +
                   v[15] * x[11])) *
                    y[9] +
                (-(v[8] * x[9] + v[10] * x[10] + v[4] * x[11])) * y[10] +
                (-(v[24] * x[9] + v[26] * x[10] + v[23] * x[11])) * y[11] +
                (-(v[16] * x[9] + v[27] * x[10] + v[3] * x[11])) * y[12];
            y[2] = (-(v[9] * x[12] + v[7] * x[13] + v[0] * x[14] + v[25] * x[15] + v[28] * x[16] +
                      v[14] * x[17])) *
                       y[7] +
                   (-(v[32] * x[12] + v[1] * x[13] + v[34] * x[14] + v[13] * x[15] + v[33] * x[16] +
                      v[12] * x[17])) *
                       y[8] +
                   (-(v[31] * x[12] + v[2] * x[13] + v[35] * x[14] + v[22] * x[15] + v[20] * x[16] +
                      v[15] * x[17])) *
                       y[9] +
                   (-(v[8] * x[15] + v[10] * x[16] + v[4] * x[17])) * y[10] +
                   (-(v[24] * x[15] + v[26] * x[16] + v[23] * x[17])) * y[11] +
                   (-(v[16] * x[15] + v[27] * x[16] + v[3] * x[17])) * y[12];
            y[3] = (-(v[9] * x[18] + v[7] * x[19] + v[0] * x[20] + v[25] * x[21] + v[28] * x[22] +
                      v[14] * x[23])) *
                       y[7] +
                   (-(v[32] * x[18] + v[1] * x[19] + v[34] * x[20] + v[13] * x[21] + v[33] * x[22] +
                      v[12] * x[23])) *
                       y[8] +
                   (-(v[31] * x[18] + v[2] * x[19] + v[35] * x[20] + v[22] * x[21] + v[20] * x[22] +
                      v[15] * x[23])) *
                       y[9] +
                   (-(v[8] * x[21] + v[10] * x[22] + v[4] * x[23])) * y[10] +
                   (-(v[24] * x[21] + v[26] * x[22] + v[23] * x[23])) * y[11] +
                   (-(v[16] * x[21] + v[27] * x[22] + v[3] * x[23])) * y[12];
            y[4] = (-(v[9] * x[24] + v[7] * x[25] + v[0] * x[26] + v[25] * x[27] + v[28] * x[28] +
                      v[14] * x[29])) *
                       y[7] +
                   (-(v[32] * x[24] + v[1] * x[25] + v[34] * x[26] + v[13] * x[27] + v[33] * x[28] +
                      v[12] * x[29])) *
                       y[8] +
                   (-(v[31] * x[24] + v[2] * x[25] + v[35] * x[26] + v[22] * x[27] + v[20] * x[28] +
                      v[15] * x[29])) *
                       y[9] +
                   (-(v[8] * x[27] + v[10] * x[28] + v[4] * x[29])) * y[10] +
                   (-(v[24] * x[27] + v[26] * x[28] + v[23] * x[29])) * y[11] +
                   (-(v[16] * x[27] + v[27] * x[28] + v[3] * x[29])) * y[12];
            y[5] = (-(v[9] * x[30] + v[7] * x[31] + v[0] * x[32] + v[25] * x[33] + v[28] * x[34] +
                      v[14] * x[35])) *
                       y[7] +
                   (-(v[32] * x[30] + v[1] * x[31] + v[34] * x[32] + v[13] * x[33] + v[33] * x[34] +
                      v[12] * x[35])) *
                       y[8] +
                   (-(v[31] * x[30] + v[2] * x[31] + v[35] * x[32] + v[22] * x[33] + v[20] * x[34] +
                      v[15] * x[35])) *
                       y[9] +
                   (-(v[8] * x[33] + v[10] * x[34] + v[4] * x[35])) * y[10] +
                   (-(v[24] * x[33] + v[26] * x[34] + v[23] * x[35])) * y[11] +
                   (-(v[16] * x[33] + v[27] * x[34] + v[3] * x[35])) * y[12];
            y[6] = (-(v[9] * x[36] + v[7] * x[37] + v[0] * x[38] + v[25] * x[39] + v[28] * x[40] +
                      v[14] * x[41])) *
                       y[7] +
                   (-(v[32] * x[36] + v[1] * x[37] + v[34] * x[38] + v[13] * x[39] + v[33] * x[40] +
                      v[12] * x[41])) *
                       y[8] +
                   (-(v[31] * x[36] + v[2] * x[37] + v[35] * x[38] + v[22] * x[39] + v[20] * x[40] +
                      v[15] * x[41])) *
                       y[9] +
                   (-(v[8] * x[39] + v[10] * x[40] + v[4] * x[41])) * y[10] +
                   (-(v[24] * x[39] + v[26] * x[40] + v[23] * x[41])) * y[11] +
                   (-(v[16] * x[39] + v[27] * x[40] + v[3] * x[41])) * y[12];
            y[13] =
                std::sqrt(y[7] * y[7] + y[8] * y[8] + y[9] * y[9] + y[10] * y[10] + y[11] * y[11] + y[12] * y[12]);

            std::copy_n(&y[0], 7, grad.begin());
            std::copy_n(&y[7], 6, error.begin());
            return y[7 + 6];
        }

        // template <std::size_t rake>
        // inline static auto jacobian_solve_config(
        //     const KinJacBlock<rake> &J,
        //     const SE3Block<rake> &T,
        //     const ConfigurationBlock<rake> &grad,
        //     const ConfigurationBlock<rake> &err) noexcept
        // {
        //     FloatVector<rake, se3_dim + kin_jac_dim> x;

        //     std::array<FloatVector<rake, 1>, 36> v;
        //     std::array<FloatVector<rake, 1>, 14> y;

        //     v[0] = x[42] + x[47] + x[52];
        //     // v[1] = (v[0] > 3) ? 0. : acos((v[0] - 1.) / 2.);
        //     v[1] = (v[0] < -1.) ? 3.14159265358979 : v[1];
        //     // if (v[0] > 3.)
        //     // {
        //     //     v[1] = 0.;
        //     // }
        ...
        //     // }
        //     v[2] = sin(v[1]) / (1. - cos(v[1]));
        //     v[3] = (v[1] < 0.0001220703125) ? (0.0833333333333333 + (v[1] * v[1]) / 720.) :  1. / (v[1] * v[1]) - v[2] / (2. * v[1]);
        ...
        //     //     v[6] = 0.;
        //     // }
        //     v[7] = (v[1] > 0.0001220703125) ? (v[1] / sin(v[1])) : 1;
        //     // if (v[1] > 0.0001220703125)
        //     // {
        //     //     v[7] = v[1] / sin(v[1]);
        //     // }
        ...
        //     // }
        //     v[7] = v[7] / 2.;
        //     v[6] = (v[1] >= 3.13159265358979) ? (v[4] * v[6]) : v[7] * (x[51] - x[48]);
        //     // if (v[1] >= 3.13159265358979)
        //     // {
        //     //     v[6] = v[4] * v[6];
        //     // }
        ...
        //     v[8] += (v[1] < 0.0001220703125 ? (0.5 * (2. - (v[1] * v[1]) / 6.)) : 0.5 * v[1] * v[2]);
        //     // if (v[1] < 0.0001220703125)
        //     // {
        //     //     v[8] = v[8] + 0.5 * (2. - (v[1] * v[1]) / 6.);
        //     // }
        ...
        //            (-(v[16] * x[39] + v[27] * x[40] + v[3] * x[41])) * y[12];
        //     y[13] =
        //         sqrt(y[7] * y[7] + y[8] * y[8] + y[9] * y[9] + y[10] * y[10] + y[11] * y[11] + y[12] * y[12]);
