...
template <typename Robot, std::size_t rake, std::size_t num_polygons>
    class CoMTaskSpaceConstraint : public RobotConstraint<Robot, rake, CoMTaskSpaceConstraint<Robot, rake>>
    {
        /**
         */
    protected:
    ...
    public:
            ...
            const std::array<float, 2 * num_polygons> polygon_points)
        {
            ...
            RobotConstraint<Robot, rake, CoMTaskSpaceConstraint<Robot, rake>>::template assignBlock<2 * num_polygons>(polygon_points, com_jac_polygons.polygon_points);
        }
            ...
            float alpha = 1.0F)
        {
            ...
            RobotConstraint<Robot, rake, CoMTaskSpaceConstraint<Robot, rake>>::integrateJointConfiguration(q, q_new, grad, alpha);
            return dist;
        }
