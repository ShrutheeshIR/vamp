                            ...
                            for (const auto std_dev_scaling_factor : std_dev_scaling_factors)
                            {
                                ...
                                if (result.path.size() > 0)
                                {
                                        ...
                                        (succ_attempts.size() > 0 && a < succ_attempts[0]))
                                    {
                                        ...
                                        // vamp::planning::constraint::invalid_distance_counter_outside <<
                                        // std::endl; std::cout << "Invalid distance counter inside: " <<
                                        // vamp::planning::constraint::invalid_distance_counter_inside <<
                                        // std::endl; std::cout << "Collision counter: " <<
                                        // vamp::planning::constraint::collision_counter << std::endl;
                                        // std::cout << "Unable to project counter: " <<
