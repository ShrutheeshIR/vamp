...
static constexpr Robot::ConfigurationArray start = {-1.45830, 1.61440, 1.66240, -1.58050, -1.61370, 1.47890, -2.23790};
static constexpr Robot::ConfigurationArray goal = {0.99900, 0.41790, 0.21120, -2.00290, -0.12750, 2.40840, -1.06870};
...
auto main(int, char **) -> int
{
    ...
    std::array<float, 6 * Robot::n_eef> tsr_lower_bound = {
        -10.01, -0.001, -10.01, -0.01, -10.01, -0.01
    };
    ...
    if(result.path.size() > 0)
    {
        ...
        std::cout << "Succeeded in planning with time: " << result.nanoseconds / 1e6 << "ms, iterations: " << result.iterations << ", path length: " << result.path.size() << " with range " << range << std::endl;
