...
static constexpr Robot::ConfigurationArray start = {-0.75,0.21,-0.05,-2.29,-0.32,2.44,1.64, -0.75,0.21,-0.05,-2.29,-0.32,2.44,1.64};
static constexpr Robot::ConfigurationArray goal = {1.1,0.65,-0.05,-1.58,-0.32,2.37,-1.03, 1.31,0.65,-0.05,-1.58,-0.32,2.37,-1.03};
