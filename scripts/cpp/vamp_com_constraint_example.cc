...
auto main(int, char **) -> int
{
    ...
    std::array<float, 8> polygon_points = {
        ...
        0.20, -0.25, 0.20, 0.25, 0.00, 0.25, 0.00, -0.25
    ...
    std::array<float, 6 * Robot::n_eef> tsr_lower_bound = {
        -10.0, -10.0, -10.0, -10.0, -10.0, -10.0, -10.0, -10.0, -10.0, -10.0, -10.0, -10.0, -0.02, -0.01, -0.01, -0.05, -0.05, -0.05, -0.02, -0.01, -0.01, -0.05, -0.05, -0.05
    };
